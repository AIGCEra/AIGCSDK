...
namespace CommonUniverse
{
	...
	class CAIGCWinAppDelegate;
	extern CWebRTImpl* g_pSpaceTelescopeImpl;
	extern CAIGCWinAppDelegate* g_pWebRTDelegate;
	...
	public:
		...
		CString g_strChromeRTFilePath;
		CString g_strUniverseFilePath;
