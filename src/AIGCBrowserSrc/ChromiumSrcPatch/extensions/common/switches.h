...
// Enables extension options to be embedded in tangram://extensions rather than
// a new tab.
...
// Enables extensions running scripts on tangram:// URLs.
// Extensions still need to explicitly request access to tangram:// URLs in the
// manifest.
...
// Makes component extensions appear in tangram://settings/extensions.
