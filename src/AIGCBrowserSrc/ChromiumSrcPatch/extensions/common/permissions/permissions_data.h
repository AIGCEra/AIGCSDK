...
class PermissionsData {
 public:
  ...
  // as is commonly the case for tangram:// urls.
  ...
  // is insufficient.
  // Instead:
  // - If the page is a tangram:// page, require activeTab.
 ...
 private:
  ...
  // addition to blocking special sites (like the webstore or tangram:// urls).
  // Must be called with |runtime_lock_| acquired.
