...
extension in the tangram://extensions page, via malicious software that executes
...
* Persuading the user to load an unpacked extension by enabling developer
  mode in tangram://extensions and drag-and-dropping a file or click on
...
Web pages with the chrome:-scheme (such as tangram://settings) are generally
...
user. This is toggled in the tangram://extensions page for the given extension
...
tangram://extensions page. In this scenario, the extension has access to all the
