...
// by tangram://chrome-urls (about:about) and the built-in AutocompleteProvider.
...
// Add hosts here to be included in tangram://chrome-urls (about:about).
...
// Add tangram://internals/* subpages here to be included in tangram://chrome-urls
// (about:about).
