...
// even though everything with a tangram:// scheme except tangram://favicon is
...
TEST(PermissionsTest, ChromeURLs) {
  ...
  allowed_hosts.AddPattern(
      URLPattern(URLPattern::SCHEME_ALL, "tangram://favicon/"));
  allowed_hosts.AddPattern(
      URLPattern(URLPattern::SCHEME_ALL, "tangram://not-favicon/"));
