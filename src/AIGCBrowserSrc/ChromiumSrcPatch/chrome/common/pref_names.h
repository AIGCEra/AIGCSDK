...
// Boolean preference that triggers tangram://settings/androidApps/details to be
// opened on user session start.
inline constexpr char kShowArcSettingsOnSessionStart[] =
    "start_arc_settings_on_session_start";

// Boolean preference that triggers tangram://settings/syncSetup to be opened
...
// String that indicates which API tangram://accessibility should show on the
...
// page (tangram://settings/importData).
...
// remote debugging at tangram://inspect.
