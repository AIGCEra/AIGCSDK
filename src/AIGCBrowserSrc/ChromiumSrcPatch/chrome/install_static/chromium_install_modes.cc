...
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Chromium.
    {
        ...
        .base_app_name = L"Tangram",              // A distinct base_app_name.
        .base_app_id = L"Tangram",                // A distinct base_app_id.
        .browser_prog_id_prefix = L"TangramHTM",  // Browser ProgID prefix.
        .browser_prog_id_description =
            L"Tangram HTML Document",         // Browser ProgID description.
        .pdf_prog_id_prefix = L"TangramPDF",  // PDF ProgID prefix.
        .pdf_prog_id_description =
            L"Tangram PDF Document",  // PDF ProgID description.
        .active_setup_guid =
