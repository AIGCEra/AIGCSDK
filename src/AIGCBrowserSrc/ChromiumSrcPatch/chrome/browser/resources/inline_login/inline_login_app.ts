...
import type {AuthCompletedCredentials, AuthParams} from 'tangram://chrome-signin/gaia_auth_host/authenticator.js';
import {Authenticator} from 'tangram://chrome-signin/gaia_auth_host/authenticator.js';
