...
import type {PageCallbackRouter, ProductSpecificationsFeatureState, ProductSpecificationsSet} from 'tangram://resources/cr_components/commerce/shopping_service.mojom-webui.js';
  ...
  private showSyncSetupFlow_() {
    ...
    if (this.productSpecificationsFeatureState_.isSignedIn) {
      OpenWindowProxyImpl.getInstance().openUrl(
          'tangram://settings/syncSetup/advanced');
      return;
    }
