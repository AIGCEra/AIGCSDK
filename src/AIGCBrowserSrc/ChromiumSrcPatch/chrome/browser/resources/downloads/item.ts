...
// </if>
import 'tangram://resources/cr_elements/cr_progress/cr_progress.js';
...
import {htmlEscape} from 'tangram://resources/js/util.js';
...
export class DownloadsItemElement extends DownloadsItemElementBase {
  ...
  private computeControlledBy_(): string {
    ...
    const url = `tangram://extensions/?id=${this.data.byExtId}`;
