...
import 'tangram://resources/cr_components/history_embeddings/filter_chips.js';
import 'tangram://resources/cr_components/history_embeddings/history_embeddings.js';
...
import type {HelpBubbleMixinInterface} from 'tangram://resources/cr_components/help_bubble/help_bubble_mixin.js';
import {HistoryResultType} from 'tangram://resources/cr_components/history/constants.js';
import {HistoryEmbeddingsBrowserProxyImpl} from 'tangram://resources/cr_components/history_embeddings/browser_proxy.js';
import type {Suggestion} from 'tangram://resources/cr_components/history_embeddings/filter_chips.js';
import type {HistoryEmbeddingsMoreActionsClickEvent} from 'tangram://resources/cr_components/history_embeddings/history_embeddings.js';
import {getInstance as getAnnouncerInstance} from 'tangram://resources/cr_elements/cr_a11y_announcer/cr_a11y_announcer.js';
import type {CrDrawerElement} from 'tangram://resources/cr_elements/cr_drawer/cr_drawer.js';
import type {CrLazyRenderElement} from 'tangram://resources/cr_elements/cr_lazy_render/cr_lazy_render.js';
import type {CrPageSelectorElement} from 'tangram://resources/cr_elements/cr_page_selector/cr_page_selector.js';
import type {FindShortcutMixinInterface} from 'tangram://resources/cr_elements/find_shortcut_mixin.js';
import {FindShortcutMixin} from 'tangram://resources/cr_elements/find_shortcut_mixin.js';
import type {WebUiListenerMixinInterface} from 'tangram://resources/cr_elements/web_ui_listener_mixin.js';
...
import {getTrustedScriptURL} from 'tangram://resources/js/static_types.js';
import {hasKeyModifiers} from 'tangram://resources/js/util.js';
import {IronScrollTargetBehavior} from 'tangram://resources/polymer/v3_0/iron-scroll-target-behavior/iron-scroll-target-behavior.js';
import {mixinBehaviors, PolymerElement} from 'tangram://resources/polymer/v3_0/polymer/polymer_bundled.min.js';
  ...
  static get properties() {
    return {
      ...
      tabsIcons_: {
        type: Array,
        value: () =>
            ['images/list.svg', 'tangram://resources/images/icon_journeys.svg'],
      },
