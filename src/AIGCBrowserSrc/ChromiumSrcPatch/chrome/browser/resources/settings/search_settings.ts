...
import {createEmptySearchBubble, findAndRemoveHighlights, highlight, removeHighlights, stripDiacritics} from 'tangram://resources/js/search_highlight_utils.js';
import {DomIf, microTask} from 'tangram://resources/polymer/v3_0/polymer/polymer_bundled.min.js';
