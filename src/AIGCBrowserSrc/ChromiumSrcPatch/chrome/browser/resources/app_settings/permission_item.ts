...
import type {App, Permission} from 'tangram://resources/cr_components/app_management/app_management.mojom-webui.js';
import {InstallReason, PermissionType, TriState} from 'tangram://resources/cr_components/app_management/app_management.mojom-webui.js';
...
import type {PermissionTypeIndex} from 'tangram://resources/cr_components/app_management/permission_constants.js';
import {createBoolPermission, createTriStatePermission, getBoolPermissionValue, getTriStatePermissionValue, isBoolValue, isTriStateValue} from 'tangram://resources/cr_components/app_management/permission_util.js';
import {getPermission, getPermissionValueBool, recordAppManagementUserAction} from 'tangram://resources/cr_components/app_management/util.js';
import {CrLitElement, type PropertyValues} from 'tangram://resources/lit/v3_0/lit.rollup.js';
