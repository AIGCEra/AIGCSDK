...
import type {Range} from 'tangram://resources/js/search_highlight_utils.js';
import {createEmptySearchBubble, highlight, stripDiacritics} from 'tangram://resources/js/search_highlight_utils.js';
