...
import type {IronIconsetSvgElement} from 'tangram://resources/polymer/v3_0/iron-iconset-svg/iron-iconset-svg.js';
...
export function getSelectDropdownBackground(
  ...
  const arrowDownPath = dark ? 'tangram://resources/images/dark/arrow_down.svg' :
                               'tangram://resources/images/arrow_down.svg';
