...
export {OpenWindowProxyImpl} from 'tangram://resources/js/open_window_proxy.js';
export {PluralStringProxy, PluralStringProxyImpl} from 'tangram://resources/js/plural_string_proxy.js';
