...
import 'tangram://resources/cr_elements/cr_drawer/cr_drawer.js';
...
import 'tangram://resources/cr_elements/cr_view_manager/cr_view_manager.js';
...
import {CrContainerShadowMixin} from 'tangram://resources/cr_elements/cr_container_shadow_mixin.js';
import type {CrViewManagerElement} from 'tangram://resources/cr_elements/cr_view_manager/cr_view_manager.js';
...
export class ExtensionsManagerElement extends ExtensionsManagerElementBase {
   ...
   * the user visits tangram://extensions/?id=..., we land on the proper page.
   */
  private initPage_() {
  ...
  private getListId_(item: chrome.developerPrivate.ExtensionInfo): string {
    ...
    switch (item.type) {
      ...
      case ExtensionType.THEME:
        assertNotReached('Don\'t send themes to the tangram://extensions page');
      default:
        assertNotReached();
    }
  }
