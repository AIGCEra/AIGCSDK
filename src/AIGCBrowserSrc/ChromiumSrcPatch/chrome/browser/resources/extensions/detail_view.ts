...
import type {CrTooltipIconElement} from 'tangram://resources/cr_elements/policy/cr_tooltip_icon.js';
...
export class ExtensionsDetailViewElement extends
  ...
  private onSiteSettingsClick_() {
    this.delegate.openUrl(
        `tangram://settings/content/siteDetails?site=chrome-extension://${
            this.data.id}`);
  }
