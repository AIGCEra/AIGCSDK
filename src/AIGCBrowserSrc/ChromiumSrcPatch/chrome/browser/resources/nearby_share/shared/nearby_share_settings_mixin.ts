...
import type {DataUsage, FastInitiationNotificationState, NearbyShareSettingsInterface, NearbyShareSettingsObserverReceiver, NearbyShareSettingsRemote, Visibility} from 'tangram://resources/mojo/chromeos/ash/services/nearby/public/mojom/nearby_share_settings.mojom-webui.js';
import type {PolymerElement} from 'tangram://resources/polymer/v3_0/polymer/polymer_bundled.min.js';
import {dedupingMixin} from 'tangram://resources/polymer/v3_0/polymer/polymer_bundled.min.js';
