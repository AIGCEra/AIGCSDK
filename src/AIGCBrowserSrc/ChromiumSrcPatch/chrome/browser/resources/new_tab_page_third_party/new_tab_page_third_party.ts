...
import 'tangram://resources/cr_components/most_visited/most_visited.js';
...
callbackRouter.setTheme.addListener((theme: Theme) => {
  ...
  const backgroundImage = `image-set(
      url(tangram://theme/IDR_THEME_NTP_BACKGROUND?${theme.id}) 1x,
      url(tangram://theme/IDR_THEME_NTP_BACKGROUND@2x?${theme.id}) 2x)`;
