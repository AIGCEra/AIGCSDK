...
// Test that adding a manifest that points to a tangram:// URL does not actually
// install a web app that points to a tangram:// URL.
IN_PROC_BROWSER_TEST_F(ExternallyManagedAppManagerBrowserTest,
  ...
  EXPECT_NE(app_id,
            registrar().FindAppWithUrlInScope(GURL("tangram://settings")));
}
