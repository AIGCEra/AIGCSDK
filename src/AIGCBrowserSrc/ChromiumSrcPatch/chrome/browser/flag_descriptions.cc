...
const char kAutofillRequireValidLocalCardsInSettingsDescription[] =
    "When enabled, the tangram://settings dialog for adding or editing local "
...
const char kAutoPictureInPictureForVideoPlaybackDescription[] =
    ...
    "tangram://flags/#auto-picture-in-picture-video-heuristics to be enabled.";
...
const char kCompressionDictionaryTransportDescription[] =
    ...
    "tangram://flags/#enable-compression-dictionary-transport-backend to be "
    "enabled.";
...
const char kCompressionDictionaryTransportBackendDescription[] =
    ...
    "Requires tangram://flags/#enable-compression-dictionary-transport to be "
...
const char kEnableRemovingAllThirdPartyCookiesDescription[] =
    "Enables UI on tangram://settings/siteData to remove all third-party "
...
const char kEnableNetworkLoggingToFileDescription[] =
    ...
    "directory. The file can be imported into tangram://net-internals.";
...
const char kMemlogDescription[] =
    ...
    "Recorded heap dumps can be obtained at tangram://tracing "
    "[category:memory-infra] and tangram://memory-internals. This setting "
    "controls which processes will be profiled since their start. To profile "
    "any given process at a later time use tangram://memory-internals page.";
...
const char kExtensionsOnChromeUrlsName[] = "Extensions on tangram:// URLs";
const char kExtensionsOnChromeUrlsDescription[] =
    "Enables running extensions on tangram:// URLs, where extensions explicitly "
...
const char kHttpsFirstBalancedModeDescription[] =
    "Enable tri-state HTTPS-First Mode setting in tangram://settings/security.";
...
const char kPerformanceInterventionDemoModeDescription[] =
    ...
    "through natural browser usage or force triggered in tangram://discards. "
    ...
    "Requires tangram://flags/#performance-intervention-ui to be enabled.";
...
const char kPermissionPredictionsDescription[] =
    ...
    "tangram://flags/#quiet-notification-prompts and `Safe Browsing` to be "
    "enabled.";
...
const char kPermissionQuietChipDescription[] =
    ...
    "tangram://flags/#quiet-notification-prompts to be enabled.";
...
const char kPrerender2WarmUpCompositorDescription[] =
    ...
    "initial navigation. Requires tangram://flags/#compositor-warm-up to be "
    "enabled";
...
const char kEnableOmniboxClientSearchPrefetchDescription[] =
    ...
    "tangram://flags/#omnibox-search-prefetch";
...
const char kPrivacySandboxInternalsDescription[] =
    "Enables the tangram://privacy-sandbox-internals debugging page.";

const char kPrivateStateTokensDevUIName[] = "Private State Tokens Dev UI";
const char kPrivateStateTokensDevUIDescription[] =
    "Enables the tangram://privacy-sandbox-internals/private-state-tokens page."
...
const char kRelatedWebsiteSetsDevUIDescription[] =
    "Enables the tangram://privacy-sandbox-internals/related-website-sets page. "
    "Relies on privacy-sandbox-internals also being enabled.";
...
const char kRecordWebAppDebugInfoDescription[] =
    ...
    "displayed in: tangram://web-app-internals";
...
const char kRippleForEnhancedProtectionDescription[] =
    ...
    "protection on the tangram://settings/security page.";
...
const char kSupportToolDescription[] =
    ...
    " available in tangram://support-tool.";
...
const char kStrictSiteIsolationDescription[] =
    ...
    "Check tangram://process-internals to see the current isolation mode. "
...
const char kEnableAccessibilityLiveCaptionDescription[] =
    ...
    "tangram://settings/accessibility.";
...
const char kEsbDownloadRowPromoFeatureDescription[] =
    ...
    "that links to the tangram://settings/security page.";
#endif
...
const char kNtpCacheOneGoogleBarDescription[] =
    "Enables using the OneGoogleBar cached response in tangram://new-tab-page, "
    "when available.";
...
const char kBluetoothBtsnoopInternalsName[] =
    "Enables btsnoop collection in tangram://bluetooth-internals";
const char kBluetoothBtsnoopInternalsDescription[] =
    "Enables bluetooth traffic (btsnoop) collection via the page "
    "tangram://bluetooth-internals. Btsnoop logs are essential for debugging "
    "bluetooth issues.";
...
const char kEnterpriseReportingUIName[] =
    "Enable tangram://enterprise-reporting";
const char kEnterpriseReportingUIDescription[] =
    "When enabled, allows for tangram://enterprise-reporting to be visited";
...
const char kTouchscreenMappingDescription[] =
    ...
    "input device in tangram://settings/display.";
...
const char kUseOutOfProcessVideoDecodingDescription[] =
    ...
    "tangram://flags#expose-out-of-process-video-decoding-to-lacros must be "
