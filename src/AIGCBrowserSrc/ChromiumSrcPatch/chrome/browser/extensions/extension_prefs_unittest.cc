...
class ExtensionPrefsGrantedPermissions : public ExtensionPrefsTest {
 public:
  void Initialize() override {
    ...
    AddPattern(&ehost_perm_set1_, "tangram://favicon/*");
    ...
    AddPattern(&ehost_permissions_, "tangram://favicon/*");
 ...
 public:
  void Initialize() override {
...

    {
      ...
      AddPattern(&ehosts, "tangram://favicon/*");
...
class ExtensionPrefsComponentExtension : public ExtensionPrefsTest {
 public:
  ...
  void Initialize() override {
    ...
    URLPatternSet shosts;
    AddPattern(&shosts, "tangram://print/*");
  ...
  void Verify() override {
    // Component extension can access tangram://print/*.
    ...
    // Non Component extension can not access tangram://print/*.
