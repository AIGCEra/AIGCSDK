...
void ExtensionService::PostActivateExtension(
  ...
  // If the extension has permission to load tangram://favicon/ resources we need
  ...
  // Same for tangram://theme/ resources.
...
void ExtensionService::PreAddExtension(const Extension* extension,
  ...
  // is the case, we don't show the toggle in the tangram://extensions page.
