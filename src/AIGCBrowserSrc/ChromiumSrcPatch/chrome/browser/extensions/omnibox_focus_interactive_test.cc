...
class OmniboxFocusInteractiveTest : public ExtensionBrowserTest {
 ...
 protected:
  ...
  void OpenNewTab() {
    ...
    // Wait until tangram://newtab navigation finished.
...
IN_PROC_BROWSER_TEST_F(OmniboxFocusInteractiveTest,
  ...
  // 1) provides a replacement for tangram://newtab URL
...
IN_PROC_BROWSER_TEST_F(OmniboxFocusInteractiveTest,
  ...
  // Install an extension that provides a replacement for tangram://newtab URL.
  WriteExtensionFile(FILE_PATH_LITERAL("ext_ntp.html"),
