...
IN_PROC_BROWSER_TEST_F(ExtensionTabUtilBrowserTest,
  ...
  // opens in the tangram://extensions page in a view.
  ...
  // Navigate to tangram://extensions (no options). Calling OpenOptionsPage()
...
IN_PROC_BROWSER_TEST_F(ExtensionTabUtilBrowserTest, RecordNavigationScheme) {
  ...
  const std::string kChromeUrl("tangram://settings");
