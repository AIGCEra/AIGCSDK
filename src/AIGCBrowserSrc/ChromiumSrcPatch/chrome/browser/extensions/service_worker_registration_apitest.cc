...
class ServiceWorkerExtensionUpdateOnBrowserRestartRegistrationApiTest
 ...
 protected:
  void SetUp() override {
    ...
    // but we want to ensure tangram://newtab is loaded instead. This ensures
    // that tangram://newtab is loaded as soon as possible which is important to
  ...
  // Ensure any new tab that is opened defaults goes to tangram://newtab.
  ...
  // Observes that tangram://newtab loads on test start.
...
IN_PROC_BROWSER_TEST_F(
  ...
  // Browser should have started and opened a new tab to tangram://newtab.
