...
void PermissionsUpdater::RevokeRuntimePermissions(
  ...
  // they were included in the removal set. This includes tangram://favicon
  ...
  std::unique_ptr<const PermissionSet> permissions_to_keep;
  {
    ...
    // Don't allow removing tangram://favicon, if it was previously granted.
...
void PermissionsUpdater::NotifyPermissionsUpdated(
  ...
  // tangram://extensions. Disabled extensions will have their permissions
