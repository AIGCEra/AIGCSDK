...
DeveloperPrivateGetProfileConfigurationFunction::Run() {
  ...
  // If this is called from the tangram://extensions page, we use this as a
...
DeveloperPrivateUpdateExtensionConfigurationFunction::Run() {
  ...
  // The tangram://extensions page uses toggles which, when dragged, do not
  // invoke a user gesture. Work around this for the tangram://extensions page.
