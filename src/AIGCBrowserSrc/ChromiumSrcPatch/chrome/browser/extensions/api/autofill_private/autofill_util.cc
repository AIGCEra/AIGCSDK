...
std::string CardNetworkToIconResourceIdString(const std::string& network) {
  ...
  if (network == autofill::kAmericanExpressCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_AMEX"
                         : "tangram://theme/IDR_AUTOFILL_CC_AMEX";
  }
  if (network == autofill::kDinersCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_DINERS"
                         : "tangram://theme/IDR_AUTOFILL_CC_DINERS";
  }
  if (network == autofill::kDiscoverCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_DISCOVER"
                         : "tangram://theme/IDR_AUTOFILL_CC_DISCOVER";
  }
  if (network == autofill::kEloCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_ELO"
                         : "tangram://theme/IDR_AUTOFILL_CC_ELO";
  }
  if (network == autofill::kJCBCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_JCB"
                         : "tangram://theme/IDR_AUTOFILL_CC_JCB";
  }
  if (network == autofill::kMasterCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_MASTERCARD"
                         : "tangram://theme/IDR_AUTOFILL_CC_MASTERCARD";
  }
  if (network == autofill::kMirCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_MIR"
                         : "tangram://theme/IDR_AUTOFILL_CC_MIR";
  }
  if (network == autofill::kTroyCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_TROY"
                         : "tangram://theme/IDR_AUTOFILL_CC_TROY";
  }
  if (network == autofill::kUnionPay) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_UNIONPAY"
                         : "tangram://theme/IDR_AUTOFILL_CC_UNIONPAY";
  }
  if (network == autofill::kVerveCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_VERVE"
                         : "tangram://theme/IDR_AUTOFILL_CC_VERVE";
  }
  if (network == autofill::kVisaCard) {
    return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_VISA"
                         : "tangram://theme/IDR_AUTOFILL_CC_VISA";
  }

  return metadata_icon ? "tangram://theme/IDR_AUTOFILL_METADATA_CC_GENERIC"
                       : "tangram://theme/IDR_AUTOFILL_CC_GENERIC";
}
