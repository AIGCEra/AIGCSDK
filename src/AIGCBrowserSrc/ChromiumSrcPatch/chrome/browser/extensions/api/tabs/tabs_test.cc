...
IN_PROC_BROWSER_TEST_F(ExtensionTabsZoomTest, ZoomSettings) {
  ...
  // tangram:// urls). We achieve this by noting that about:blank meets these
...
IN_PROC_BROWSER_TEST_F(ExtensionTabsZoomTest, CannotZoomInvalidTab) {
  ...
  const char kNewTestTabArgs[] = "tangram://version";
...
IN_PROC_BROWSER_TEST_F(ExtensionApiTest, TabsUpdate_WebToAboutNewTab) {
  ...
  // https://crbug.com/1145381: about:version is rewritten to tangram://version
  ...
  GURL chrome_newtab_url = GURL("tangram://new-tab-page/");
