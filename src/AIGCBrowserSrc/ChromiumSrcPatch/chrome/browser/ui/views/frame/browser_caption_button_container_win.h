...
class BrowserCaptionButtonContainer : public views::View,
 ...
 private:
  ...
  raw_ptr<WindowsCaptionButton> minimize_button_;
  raw_ptr<WindowsCaptionButton> maximize_button_;
  raw_ptr<WindowsCaptionButton> restore_button_;
  raw_ptr<WindowsCaptionButton> close_button_;
