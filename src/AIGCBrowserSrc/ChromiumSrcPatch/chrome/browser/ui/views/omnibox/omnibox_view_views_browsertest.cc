...
// Omnibox returns to clean state after tangram://kill and reload.
// https://crbug.com/993701 left the URL and icon as tangram://kill after reload.
IN_PROC_BROWSER_TEST_F(OmniboxViewViewsTest, DISABLED_ReloadAfterKill) {
  ...
  content::WebContents* tab =
      browser()->tab_strip_model()->GetActiveWebContents();
  // Kill the tab with tangram://kill
  {
