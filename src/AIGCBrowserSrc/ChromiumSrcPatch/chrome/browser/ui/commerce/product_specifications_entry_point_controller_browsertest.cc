...
const char kTestUrl1[] = "tangram://new-tab-page/";
const char kTestUrl2[] = "tangram://version/";
const char kTestUrl3[] = "tangram://flags/";
const char kTestUrl4[] = "tangram://management/";
