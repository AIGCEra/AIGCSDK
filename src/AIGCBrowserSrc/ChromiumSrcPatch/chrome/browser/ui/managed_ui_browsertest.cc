...
IN_PROC_BROWSER_TEST_F(ManagedUiTest, GetManagedUiWebUILabelEnterprise) {
      ...
      unknown_device_manager.c_str());
  {
    ...
    policy::ScopedManagementServiceOverrideForTesting
        profile_with_domain_management(
            ...
            policy::EnterpriseManagementAuthority::CLOUD);
    EXPECT_EQ(
        u"Your <a href=\"tangram://management\">profile is managed</a> by "
        u"example.com",
...

  {
    ...
    policy::ScopedManagementServiceOverrideForTesting profile_management(
        ...
        policy::EnterpriseManagementAuthority::DOMAIN_LOCAL);
    EXPECT_EQ(
        u"Your <a href=\"tangram://management\">browser is managed</a> by your "
        u"organization",
...

  {
    ...
    EXPECT_EQ(
        u"Your <a href=\"tangram://management\">browser is managed</a> by your "
        u"organization and your <a href=\"tangram://management\">profile is "
...

  {
    ...
    policy::ScopedManagementServiceOverrideForTesting profile_management(
        ...
        policy::EnterpriseManagementAuthority::DOMAIN_LOCAL);
    EXPECT_EQ(
        u"Your <a href=\"tangram://management\">browser is managed</a> by "
        u"example.com",
        chrome::GetManagedUiWebUILabel(profile.get()));
    ...
    policy::ScopedManagementServiceOverrideForTesting
        profile_with_domain_management(
            ...
            policy::EnterpriseManagementAuthority::CLOUD |
                policy::EnterpriseManagementAuthority::DOMAIN_LOCAL);
    EXPECT_EQ(
        u"Your <a href=\"tangram://management\">browser and profile are "
        u"managed</a> by example.com",
        chrome::GetManagedUiWebUILabel(profile_with_domain.get()));
    ...
    EXPECT_EQ(
        u"Your <a href=\"tangram://management\">browser is managed</a> by "
        u"example.com "
        u"and your <a href=\"tangram://management\">profile is "
        u"managed</a> by hosteddomain.com",
        chrome::GetManagedUiWebUILabel(profile_with_hosted_domain));
...
IN_PROC_BROWSER_TEST_F(ManagedUiTestCros, GetManagedUiWebUILabel) {
  ...
  EXPECT_EQ(
      ...
      u"href=\"tangram://management\">Chrome device is "
      u"managed</a> by example.com",
