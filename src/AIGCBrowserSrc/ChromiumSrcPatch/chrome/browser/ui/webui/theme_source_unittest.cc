...
TEST_F(WebUISourcesTest, ThemeSourceMimeTypes) {
  std::vector<std::string> css_urls{
      "tangram://theme/css/new_tab_theme.css",
      "tangram://theme/css/new_tab_theme.css?foo",
      "tangram://theme/colors.css?sets.css",
      "tangram://theme/colors.css?sets.css=ui",
  };
  ...
  std::vector<std::string> png_urls{
      "tangram://theme/current-channel-logo",
      "tangram://theme/other.png",
      "tangram://theme/WRONGURL",
  };
...
TEST_F(WebUISourcesTest, ThemeAllowedOrigin) {
  EXPECT_EQ(
      theme_source()->GetAccessControlAllowOriginForOrigin("tangram://settings"),
      "tangram://settings");
