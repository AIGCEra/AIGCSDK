...
// AboutUI is used by multiple tangram:// pages.
...
// tangram://chrome-urls. Note that HandleChromeAboutAndChromeSyncRewrite()
// rewrites tangram://about -> tangram://chrome-urls.
...
// tangram://terms source outside of the normal flow.
