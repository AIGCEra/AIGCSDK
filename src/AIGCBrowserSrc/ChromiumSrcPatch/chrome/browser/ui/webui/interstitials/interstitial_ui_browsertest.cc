...
class InterstitialUITest : public InProcessBrowserTest {
 public:
  ...
  void SetUpCommandLine(base::CommandLine* command_line) override {
    ...
    // These tests use tangram:// URLs and are written on the assumption devtools
...
IN_PROC_BROWSER_TEST_F(InterstitialUITest, HomePage) {
  TestInterstitial(GURL("tangram://interstitials"), "Interstitials");
}

IN_PROC_BROWSER_TEST_F(InterstitialUITest, InvalidURLShouldOpenHomePage) {
  // Invalid path should open the main page:
  TestInterstitial(GURL("tangram://interstitials/--invalid--"), "Interstitials");
}
...
IN_PROC_BROWSER_TEST_F(InterstitialUITest,
  ...
  TestInterstitial(GURL("tangram://interstitials/supervised-user-verify"),
...
IN_PROC_BROWSER_TEST_F(InterstitialUITest,
  ...
  TestInterstitial(
      GURL("tangram://interstitials/supervised-user-verify-blocked-site"),
...
IN_PROC_BROWSER_TEST_F(InterstitialUITest,
  ...
  TestInterstitial(
      GURL("tangram://interstitials/supervised-user-verify-subframe"), "YouTube",
...
// tangram://interstitials.
IN_PROC_BROWSER_TEST_F(InterstitialUITest, InterstitialBackButton) {
  content::WebContents* web_contents =
      browser()->tab_strip_model()->GetActiveWebContents();
  ASSERT_TRUE(
      ui_test_utils::NavigateToURL(browser(), GURL("tangram://interstitials")));
  ASSERT_TRUE(ui_test_utils::NavigateToURL(browser(),
                                           GURL("tangram://interstitials/ssl")));
...
// Tests that view-source: works correctly on tangram://interstitials.
IN_PROC_BROWSER_TEST_F(InterstitialUITest, InterstitialViewSource) {
  ASSERT_TRUE(ui_test_utils::NavigateToURL(
      browser(), GURL("view-source:tangram://interstitials/")));
  int found;
...
// tangram://interstitials (using tangram://interstitials/ssl).
...
IN_PROC_BROWSER_TEST_F(InterstitialUITest,
  ...
  ASSERT_TRUE(ui_test_utils::NavigateToURL(
      browser(), GURL("view-source:tangram://interstitials/ssl")));
  int found;
