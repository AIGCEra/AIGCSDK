...
enum class SupportToolWebUIActionType {
  ...
  // When user generates URL on tangram://support-tool/url-generator.
  kGenerateURL = 4,
  // When user generates support token on tangram://support-tool/url-generator.
  kGenerateToken = 5,
...
// The C++ back-end for the tangram://support-tool webui page.
