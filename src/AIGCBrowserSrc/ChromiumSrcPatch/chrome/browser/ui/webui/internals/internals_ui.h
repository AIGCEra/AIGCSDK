...
// Client could put debug WebUI as sub-URL under tangram://internals/.
// e.g. tangram://internals/your-feature.
...
#if BUILDFLAG(IS_ANDROID)
  // Add resources and message handler for tangram://internals/query-tiles.
  void AddQueryTilesInternals(content::WebUI* web_ui);

  // Add resources and message handler for tangram://internals/lens.
