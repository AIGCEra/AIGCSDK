...
#if BUILDFLAG(IS_CHROMEOS_ASH)
  // Set up the tangram://userimage/ source.
...
base::Value::Dict ProfileInfoHandler::GetAccountNameAndIcon() {
  ...
  // Get image as data URL instead of using tangram://userimage source to avoid
  // issues with caching.
  ...
  if (entry) {
    ...
    // TODO(crbug.com/40515148): return tangram://theme/IDR_PROFILE_AVATAR_*
