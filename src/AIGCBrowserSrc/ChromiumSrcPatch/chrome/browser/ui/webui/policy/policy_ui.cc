...
// Returns the version information to be displayed on the tangram://policy/logs
// page.
...
void CreateAndAddPolicyUIHtmlSource(Profile* profile) {
  ...
  // Localized strings for tangram://policy/logs.
  ...
  if (allow_policy_test_page) {
    // Localized strings for tangram://policy/test.
