...
constexpr char kNeedsRecordWebAppDebugInfo[] =
    ...
    "tangram://flags/#record-web-app-debug-info";
...
constexpr auto kUpdateManifestFetchAnnotation =
    ...
    semantics {
      ...
      description:
        ...
        "version."
      trigger:
        "User clicks on the discover button in tangram://web-app-internals."
    }
    policy {
...
constexpr auto kDownloadWebBundleAnnotation =
    ...
    semantics {
      ...
      trigger:
        "User accepts the installation dialog in tangram://web-app-internals."
    }
    policy {
      setting: "This feature cannot be disabled in settings."
      policy_exception_justification: "Not implemented."
