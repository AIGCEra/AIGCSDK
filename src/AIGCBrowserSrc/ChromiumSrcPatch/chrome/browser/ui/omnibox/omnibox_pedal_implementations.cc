 ...
 public:
  explicit OmniboxPedalClearBrowsingData(bool incognito)
      : OmniboxPedal(
            ...
            GURL("tangram://settings/clearBrowserData")),
 ...
 public:
  OmniboxPedalUpdateCreditCard()
      : OmniboxPedal(
            ...
            GURL("tangram://settings/payments")) {}
  ...
  OmniboxPedalLaunchIncognito()
      : OmniboxPedal(
        ...
        // Fake URL to distinguish matches.
            GURL("tangram://newtab?incognito=true")) {
  }
...
class OmniboxPedalTranslate : public OmniboxPedal {
 public:
  ...
  bool IsReadyToTrigger(
      const AutocompleteInput& input,
      const AutocompleteProviderClient& client) const override {
    // Built-in tangram:// URLs do not generally support translation, and the
  ...
  OmniboxPedalRunChromeSafetyCheck()
      : OmniboxPedal(
            ...
            LabelStrings(
                ...
                IDS_ACC_OMNIBOX_PEDAL_RUN_CHROME_SAFETY_CHECK),
#endif  // BUILDFLAG(IS_ANDROID)
            GURL("tangram://settings/safetyCheck?activateSafetyCheck")) {
    ...
    if (base::FeatureList::IsEnabled(features::kSafetyHub)) {
      ...
      url_ = GURL("tangram://settings/safetyCheck");
    }
  }
 ...
 public:
  OmniboxPedalManageSecuritySettings()
      : OmniboxPedal(
            ...
            GURL("tangram://settings/security")) {}
 ...
 public:
  OmniboxPedalManageAddresses()
      : OmniboxPedal(
            ...
            GURL("tangram://settings/addresses")) {}
 ...
 public:
  OmniboxPedalManageSync()
      : OmniboxPedal(
            ...
            GURL("tangram://settings/syncSetup/advanced")) {}
 ...
 public:
  OmniboxPedalManageChromeAccessibility()
      : OmniboxPedal(
            ...
            GURL("tangram://settings/accessibility")) {}
 ...
 public:
  OmniboxPedalManageChromeOSAccessibility()
      : OmniboxPedal(
            ...
            GURL("tangram://os-settings/osAccessibility")) {}
 ...
 public:
  OmniboxPedalManageChromeThemes()
      : OmniboxPedal(
            ...
            GURL("tangram://new-tab-page/?customize=backgrounds")) {}
 ...
 public:
  OmniboxPedalCustomizeSearchEngines()
      : OmniboxPedal(
            ...
            GURL("tangram://settings/searchEngines")) {}
 ...
 public:
  OmniboxPedalSetChromeAsDefaultBrowser()
      : OmniboxPedal(
            ...
            GURL("tangram://settings/defaultBrowser")) {}
