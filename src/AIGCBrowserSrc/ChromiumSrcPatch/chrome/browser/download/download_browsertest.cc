...
// Test for crbug.com/14505. This tests that tangram:// urls are still functional
// after download of a file while viewing another tangram://.
...
// a tangram:// page that has registered and onunload handler, the browser
