...
#if defined(OS_WIN)
static bool g_bShowTranslateUI = false;
#endif
...
// and iOS (in ios/chrome/browser/translate/chrome_ios_translate_client.mm).
  ...
  // begin Add by TangramTeam
  if (g_bShowTranslateUI == false && step == translate::TRANSLATE_STEP_BEFORE_TRANSLATE) {
      g_bShowTranslateUI = true;
      translate_manager_->RecordTranslateEvent(
          BubbleResultToTranslateEvent(ShowTranslateBubbleResult::WEB_CONTENTS_NOT_ACTIVE));
      return false;
  }
  // end Add by TangramTeam
