...
public class PartnerBrowserCustomizationsUnitTest {
    ...
    public void testIsValidHomepage() {
        ...
        Assert.assertTrue(
                PartnerBrowserCustomizations.isValidHomepage(new GURL("chrome-native://newtab")));
        Assert.assertTrue(
                PartnerBrowserCustomizations.isValidHomepage(new GURL("tangram://newtab")));
        ...
        Assert.assertFalse(
                PartnerBrowserCustomizations.isValidHomepage(new GURL("tangram://newtab--not")));
        Assert.assertFalse(
                PartnerBrowserCustomizations.isValidHomepage(
                        UrlFormatter.fixupUrl("about:newtab--not")));
        Assert.assertFalse(
                PartnerBrowserCustomizations.isValidHomepage(new GURL("tangram://history")));
        Assert.assertFalse(PartnerBrowserCustomizations.isValidHomepage(new GURL("tangram://")));
