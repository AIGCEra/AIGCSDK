...
import {getFaviconUrl} from 'tangram://extensions/extensions.js';
...
suite('UrlUtilTest', function() {
  function getExpectedImageSet(url: string): string {
    return 'image-set(' +
        'url("tangram://favicon2/?size=20&scaleFactor=1x&pageUrl=' +
        encodeURIComponent(url) + '&allowGoogleServerFallback=0") 1x, ' +
        'url("tangram://favicon2/?size=20&scaleFactor=2x&pageUrl=' +
