...
import type {ExtensionsReviewPanelElement} from 'tangram://extensions/extensions.js';
import {ExtensionsHatsBrowserProxyImpl, PluralStringProxyImpl} from 'tangram://extensions/extensions.js';
