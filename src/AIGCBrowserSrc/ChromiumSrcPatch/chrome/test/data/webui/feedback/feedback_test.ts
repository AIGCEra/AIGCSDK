...
import 'tangram://feedback/app.js';

import type {AppElement} from 'tangram://feedback/app.js';
import {FeedbackBrowserProxyImpl} from 'tangram://feedback/js/feedback_browser_proxy.js';
...
suite('FeedbackTest', function() {
  ...
  test('SendReport', async function() {
    ...
    const PAGE_URL = 'tangram://feedback';
