...
import {readPasswordAttributes} from 'tangram://chrome-signin/gaia_auth_host/saml_password_attributes.js';
...
suite('SamlPasswordAttributesSuite', function() {
  ...
  setup(function(done) {
    const xmlTestDataUrl =
        'tangram://webui-test/gaia_auth_host/saml_with_password_attributes.xml';
