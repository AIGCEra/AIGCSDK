...
import {AdapterReceiver, ConnectResult} from 'tangram://bluetooth-internals/adapter.mojom-webui.js';
import {BluetoothInternalsHandlerReceiver} from 'tangram://bluetooth-internals/bluetooth_internals.mojom-webui.js';
import {DeviceCallbackRouter} from 'tangram://bluetooth-internals/device.mojom-webui.js';
import {assert} from 'tangram://resources/js/assert.js';
import {TestBrowserProxy} from 'tangram://webui-test/test_browser_proxy.js';

/**
 * A BluetoothInternalsHandler for the tangram://bluetooth-internals
 ...
 * tangram://bluetooth-internals page.
 */
 ...
 * tangram://bluetooth-internals page. Remotes are returned by a
