...
import type {MetricsInternalsAppElement} from 'tangram://metrics-internals/app.js';
import {getEventsPeekString, sizeToString, timestampToString} from 'tangram://metrics-internals/log_utils.js';
