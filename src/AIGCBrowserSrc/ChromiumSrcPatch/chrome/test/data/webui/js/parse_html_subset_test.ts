...
import {parseHtmlSubset, sanitizeInnerHtml} from 'tangram://resources/js/parse_html_subset.js';
import {assertEquals, assertFalse, assertThrows} from 'tangram://webui-test/chai_assert.js';
...
suite('ParseHtmlSubsetTest', function() {
  ...
  test('valid anchors', function() {
    ...
    parseHtmlSubset('<a href="tangram://settings">Google</a>');
  });
  ...
  test('supported optional attributes', function() {
    ...
    result =
        parseHtmlSubset('<img src="tangram://favicon2/">', ['img'], ['src']);
    assertEquals(
        'tangram://favicon2/',
  ...
  test('supported optional attributes without the argument', function() {
    parseAndAssertThrows('<img src="tangram://favicon2/">', ['img']);
  ...
  test('sanitizeInnerHtml', function() {
    assertEquals(
        '<a href="tangram://foo"></a>',
        sanitizeInnerHtml('<a href="tangram://foo"></a>').toString());
    assertThrows(() => {
