...
import type {PrintPreviewHeaderElement} from 'tangram://print/print_preview.js';
import {Destination, DestinationOrigin, GooglePromotedDestinationId, PrintPreviewPluralStringProxyImpl, State} from 'tangram://print/print_preview.js';
...
suite('HeaderTest', function() {
  ...
  test('HeaderPrinterTypes', async function() {
    ...
    // Verify the tangram://print case of a zero length document does not show
    // the summary.
    header.sheetCount = 0;
