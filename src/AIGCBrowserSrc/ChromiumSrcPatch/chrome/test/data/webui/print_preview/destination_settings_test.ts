...
import type {LocalDestinationInfo, PrintPreviewDestinationSettingsElement, RecentDestination} from 'tangram://print/print_preview.js';
import {Destination, DestinationErrorType, DestinationOrigin, DestinationState, DestinationStoreEventType, Error, GooglePromotedDestinationId, makeRecentDestination, NativeLayerImpl, NUM_PERSISTED_DESTINATIONS, State} from 'tangram://print/print_preview.js';
...
import {fakeDataBind, waitBeforeNextRender} from 'tangram://webui-test/polymer_test_util.js';
...
suite('DestinationSettingsTest', function() {
  ...
  test('EulaIsRetrieved', function() {
    ...
    const expectedUrl = 'tangram://os-credits/eula';
    ...
    return nativeLayerCros.whenCalled('getEulaUrl')
        ...
        .then(() => {
          nativeLayerCros.setEulaUrl('tangram://os-credits/eula');
