...
import type {PrintPreviewDestinationDropdownCrosElement, PrintPreviewDestinationSelectCrosElement} from 'tangram://print/print_preview.js';
import {Destination, DestinationOrigin, Error, NativeLayerCrosImpl, NativeLayerImpl, PrinterStatusReason, PrinterStatusSeverity, State} from 'tangram://print/print_preview.js';
    ...
    return waitBeforeNextRender(destinationSelect)
        .then(() => {
          ...
          destinationSelect.set(
              'destination.eulaUrl', 'tangram://os-credits/eula');
