...
import 'tangram://print/pdf/pdf_print_wrapper.js';

import type {PdfViewerPrintElement} from 'tangram://print/pdf/pdf_print_wrapper.js';
import {pdfCreateOutOfProcessPlugin} from 'tangram://print/pdf/pdf_scripting_api.js';
...
suite('PdfViewerTest', function() {
  ...
  test('Basic', async () => {
    const plugin = pdfCreateOutOfProcessPlugin(
        ...
        'tangram://print/pdf/index_print.html');
