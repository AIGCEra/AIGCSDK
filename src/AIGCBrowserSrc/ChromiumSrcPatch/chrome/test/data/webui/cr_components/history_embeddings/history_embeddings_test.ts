...
import type {HistoryEmbeddingsElement} from 'tangram://resources/cr_components/history_embeddings/history_embeddings.js';
import {AnswerStatus, PageHandlerRemote, UserFeedback} from 'tangram://resources/cr_components/history_embeddings/history_embeddings.mojom-webui.js';
import type {SearchQuery, SearchResult, SearchResultItem} from 'tangram://resources/cr_components/history_embeddings/history_embeddings.mojom-webui.js';
