...
import type {RealboxElement, RealboxIconElement, RealboxMatchElement} from 'tangram://new-tab-page/new_tab_page.js';
import {$$, BrowserProxyImpl, decodeString16, MetricsReporterImpl, mojoString16, RealboxBrowserProxy} from 'tangram://new-tab-page/new_tab_page.js';
import {NavigationPredictor} from 'tangram://resources/cr_components/searchbox/omnibox.mojom-webui.js';
import type {AutocompleteMatch} from 'tangram://resources/cr_components/searchbox/searchbox.mojom-webui.js';
import {RenderType, SideType} from 'tangram://resources/cr_components/searchbox/searchbox.mojom-webui.js';
  ...
  */
  ...
  test('realbox default Google G icon', async () => {
    ...
    assertStyle(
        ...
        `url("tangram://resources/cr_components/searchbox/icons/google_g.svg")`);
  ...
  test('Color source baseline search icon has background image', async () => {
    ...
    assertStyle(
        ...
        'url("tangram://resources/cr_components/searchbox/icons/mic.svg")');
  ...
  test('focus indicator', async () => {
    ...
    const matches = [createSearchMatch({
      actions: [{
        ...
        iconUrl: 'tangram://theme/current-channel-logo',
      }],
