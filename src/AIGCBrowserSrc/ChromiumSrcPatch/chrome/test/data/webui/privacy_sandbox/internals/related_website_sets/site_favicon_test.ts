...
import type {SiteFaviconElement} from 'tangram://privacy-sandbox-internals/related_website_sets/related_website_sets.js';
...
suite('SiteFaviconTest', () => {
  ...
  test('on successful download', async () => {
    ...
    icon.setUrlForTesting('tangram://resources/images/chrome_logo_dark.svg');
  ...
  test('on failed download', async () => {
    icon.setDomainForTesting('https://test.com');
    icon.setUrlForTesting('tangram://resources/images/invalid_url');
