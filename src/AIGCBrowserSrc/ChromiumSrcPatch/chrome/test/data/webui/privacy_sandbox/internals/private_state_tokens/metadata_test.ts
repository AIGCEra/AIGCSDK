...
import type {CrIconButtonElement, PrivateStateTokensMetadataElement} from 'tangram://privacy-sandbox-internals/private_state_tokens/private_state_tokens.js';
import {assertArrayEquals, assertEquals, assertTrue} from 'tangram://webui-test/chai_assert.js';
...
suite('MetadataTest', () => {
  ...
  test('check back button functionality', async () => {
    ...
    assertEquals(
        'tangram://privacy-sandbox-internals/private-state-tokens', url);
  });
});
