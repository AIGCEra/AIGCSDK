...
import 'tangram://apps/app_list.js';
import 'tangram://apps/app_item.js';
import 'tangram://apps/deprecated_apps_link.js';

import type {AppInfo, PageRemote} from 'tangram://apps/app_home.mojom-webui.js';
import {RunOnOsLoginMode} from 'tangram://apps/app_home.mojom-webui.js';
import type {AppHomeEmptyPageElement} from 'tangram://apps/app_home_empty_page.js';
import {AppHomeUserAction} from 'tangram://apps/app_home_utils.js';
import type {AppListElement} from 'tangram://apps/app_list.js';
import {BrowserProxy} from 'tangram://apps/browser_proxy.js';
import type {DeprecatedAppsLinkElement} from 'tangram://apps/deprecated_apps_link.js';
...
suite('AppListTest', () => {
  ...
  setup(async () => {
      ...
      appList: [
        {
          ...
          name: 'Test App 1',
          iconUrl: {
            url: 'tangram://app-icon/ahfgeienlihckogmohjhadlkjgocpleb/128/1',
          },
        ...
        },
        {
          ...
          name: 'Test App 2',
          iconUrl: {
            url: 'tangram://app-icon/ahfgeienlihckogmotestdlkjgocpleb/128/1',
          },
    ...
    testAppInfo = {
      ...
      name: 'A Test App 3',
      iconUrl: {
        url: 'tangram://app-icon/mmfbcljfglbokpmkimbfghdkjmjhdgbg/128/1',
      },
      mayShowRunOnOsLoginMode: false,
      mayToggleRunOnOsLoginMode: false,
      runOnOsLoginMode: RunOnOsLoginMode.kNotRun,
    ...
    deprecatedAppInfo = {
      ...
      name: 'Deprecated App',
      iconUrl: {
        url: 'tangram://extension-icon/mplpmdejoamenolpcojgegminhcnmibo/128/1',
      },
      mayShowRunOnOsLoginMode: false,
      mayToggleRunOnOsLoginMode: false,
      runOnOsLoginMode: RunOnOsLoginMode.kNotRun,
