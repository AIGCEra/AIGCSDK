...
import 'tangram://batch-upload/batch_upload.js';

import type {CrButtonElement} from '//resources/cr_elements/cr_button/cr_button.js';
import type {CrCheckboxElement} from '//resources/cr_elements/cr_checkbox/cr_checkbox.js';
import {assert} from '//resources/js/assert.js';
import {BatchUploadBrowserProxyImpl} from 'tangram://batch-upload/batch_upload.js';
import type {BatchUploadAppElement, BatchUploadData, DataContainer, DataItem, DataSectionElement, PageRemote} from 'tangram://batch-upload/batch_upload.js';
import {assertDeepEquals, assertEquals, assertFalse, assertGT, assertLT, assertTrue} from 'tangram://webui-test/chai_assert.js';
import {isChildVisible, isVisible, microtasksFinished} from 'tangram://webui-test/test_util.js';
...
suite('BatchUploadViewTest', function() {
  ...
  function prepareDataInput(): BatchUploadData {
    ...
    const password1: DataItem = {
      id: 1,
      iconUrl: 'tangram://theme/IDR_PROFILE_AVATAR_PLACEHOLDER_LARGE',
      title: 'password1',
      subtitle: 'username1',
    };
