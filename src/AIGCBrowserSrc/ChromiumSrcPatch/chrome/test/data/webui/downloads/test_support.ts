...
import type {IconLoader, MojomData, PageHandlerInterface, PageRemote} from 'tangram://downloads/downloads.js';
import {DangerType, PageCallbackRouter, SafeBrowsingState, State, TailoredWarningType} from 'tangram://downloads/downloads.js';
