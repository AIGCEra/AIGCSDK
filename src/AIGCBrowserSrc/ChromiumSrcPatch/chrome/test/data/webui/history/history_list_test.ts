...
import type {HistoryAppElement, HistoryEntry, HistoryItemElement, HistoryListElement, HistoryToolbarElement} from 'tangram://history/history.js';
import {BrowserServiceImpl, CrRouter, ensureLazyLoaded} from 'tangram://history/history.js';
...
import {assertDeepEquals, assertEquals, assertFalse, assertGT, assertNotEquals, assertTrue} from 'tangram://webui-test/chai_assert.js';
...
suite('HistoryListTest', function() {
  ...
  test('DeleteDialogClosedOnBackNavigation', async function() {
    ...
    // Navigate from tangram://history/ to
    // tangram://history/?q=something else.
    ...
    // Navigate back to tangram://history.
    window.history.back();
