...
import type {ProductSpecificationsItemElement} from 'tangram://history/history.js';
import {ShoppingBrowserProxyImpl} from 'tangram://history/history.js';
...
suite('ProductSpecificationsItemTest', () => {
  ...
  test('render labels', async () => {
    ...
    assertEquals('tangram://compare/?id=ex1', url.trim());
  });
