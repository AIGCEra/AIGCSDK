...
import 'tangram://history/lazy_load.js';

import type {HistoryAppElement, HistoryEntry} from 'tangram://history/history.js';
import {BrowserServiceImpl, ensureLazyLoaded, HistoryPageViewHistogram, SYNCED_TABS_HISTOGRAM_NAME, SyncedTabsHistogram} from 'tangram://history/history.js';
