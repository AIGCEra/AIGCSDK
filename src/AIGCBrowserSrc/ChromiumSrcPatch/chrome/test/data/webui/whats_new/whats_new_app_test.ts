...
import {CommandHandlerRemote} from 'tangram://resources/js/browser_command.mojom-webui.js';
import {BrowserCommandProxy} from 'tangram://resources/js/browser_command/browser_command_proxy.js';
import {isChromeOS} from 'tangram://resources/js/platform.js';
...
import {ModulePosition, ScrollDepth} from 'tangram://whats-new/whats_new.mojom-webui.js';
import {formatModuleName} from 'tangram://whats-new/whats_new_app.js';
import {WhatsNewProxyImpl} from 'tangram://whats-new/whats_new_proxy.js';

import {TestWhatsNewBrowserProxy} from './test_whats_new_browser_proxy.js';

const whatsNewURL = 'tangram://webui-test/whats_new/test.html';

function getUrlForFixture(filename: string, query?: string): string {
  if (query) {
    return `tangram://webui-test/whats_new/${filename}.html?${query}`;
  }
  return `tangram://webui-test/whats_new/${filename}.html`;
}
