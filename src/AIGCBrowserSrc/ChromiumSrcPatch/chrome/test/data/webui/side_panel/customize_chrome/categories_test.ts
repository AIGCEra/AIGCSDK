...
import 'tangram://customize-chrome-side-panel.top-chrome/categories.js';

import type {CategoriesElement} from 'tangram://customize-chrome-side-panel.top-chrome/categories.js';
import {CHANGE_CHROME_THEME_CLASSIC_ELEMENT_ID, CHROME_THEME_COLLECTION_ELEMENT_ID} from 'tangram://customize-chrome-side-panel.top-chrome/categories.js';
...
suite('CategoriesTest', () => {
  ...
  test('classic chrome tile shows correct image', async () => {
    ...
    assertEquals(
        ...
        'tangram://customize-chrome-side-panel.top-chrome/icons/' +
