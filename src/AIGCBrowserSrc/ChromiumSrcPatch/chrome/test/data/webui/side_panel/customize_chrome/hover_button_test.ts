...
import 'tangram://customize-chrome-side-panel.top-chrome/hover_button.js';

import type {HoverButtonElement} from 'tangram://customize-chrome-side-panel.top-chrome/hover_button.js';
...
suite('HoverButtonTest', () => {
  ...
  test('icon shows', () => {
    ...
    // element.
    const crIconImage = 'url("tangram://resources/images/open_in_new.svg")';
