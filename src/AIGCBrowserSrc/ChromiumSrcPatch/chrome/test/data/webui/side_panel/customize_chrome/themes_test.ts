...
import 'tangram://customize-chrome-side-panel.top-chrome/themes.js';

import {CustomizeChromeAction, NtpImageType} from 'tangram://customize-chrome-side-panel.top-chrome/common.js';
import type {BackgroundCollection, CollectionImage, CustomizeChromePageRemote} from 'tangram://customize-chrome-side-panel.top-chrome/customize_chrome.mojom-webui.js';
import {CustomizeChromePageCallbackRouter, CustomizeChromePageHandlerRemote} from 'tangram://customize-chrome-side-panel.top-chrome/customize_chrome.mojom-webui.js';
import {CustomizeChromeApiProxy} from 'tangram://customize-chrome-side-panel.top-chrome/customize_chrome_api_proxy.js';
import type {ThemesElement} from 'tangram://customize-chrome-side-panel.top-chrome/themes.js';
import {CHROME_THEME_BACK_ELEMENT_ID, CHROME_THEME_ELEMENT_ID} from 'tangram://customize-chrome-side-panel.top-chrome/themes.js';
...
suite('ThemesTest', () => {
  ...
  test('set empty collection id on refresh daily toggle off', async () => {
    ...
    theme.backgroundImage = createBackgroundImage('tangram://theme/foo');
  ...
  test(
      ...
      async () => {
        ...
        theme = createTheme();
        theme.backgroundImage = createBackgroundImage('tangram://theme/bar');
