...
import 'tangram://bookmarks-side-panel.top-chrome/commerce/shopping_list.js';
import 'tangram://bookmarks-side-panel.top-chrome/power_bookmarks_list.js';

import {ActionSource} from 'tangram://bookmarks-side-panel.top-chrome/bookmarks.mojom-webui.js';
import {BookmarksApiProxyImpl} from 'tangram://bookmarks-side-panel.top-chrome/bookmarks_api_proxy.js';
import type {ShoppingListElement} from 'tangram://bookmarks-side-panel.top-chrome/commerce/shopping_list.js';
import {ACTION_BUTTON_TRACK_IMAGE, ACTION_BUTTON_UNTRACK_IMAGE, LOCAL_STORAGE_EXPAND_STATUS_KEY} from 'tangram://bookmarks-side-panel.top-chrome/commerce/shopping_list.js';
import {BrowserProxyImpl} from 'tangram://resources/cr_components/commerce/browser_proxy.js';
import type {BookmarkProductInfo} from 'tangram://resources/cr_components/commerce/shopping_service.mojom-webui.js';
  ...
  const products: BookmarkProductInfo[] = [
    {
      ...
      info: {
        ...
        domain: 'foo.com',
        imageUrl: {url: 'tangram://resources/images/error.svg'},
