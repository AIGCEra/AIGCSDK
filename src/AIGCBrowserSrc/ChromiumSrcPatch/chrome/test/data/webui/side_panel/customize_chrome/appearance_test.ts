...
import 'tangram://customize-chrome-side-panel.top-chrome/appearance.js';

import type {AppearanceElement} from 'tangram://customize-chrome-side-panel.top-chrome/appearance.js';
              ...
              async () => {
                ...
                if (showClassicChromeButton) {
                  theme.backgroundImage =
                      createBackgroundImage('tangram://theme/foo');
                }
