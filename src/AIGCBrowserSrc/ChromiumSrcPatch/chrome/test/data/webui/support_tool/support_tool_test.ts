...
import 'tangram://support-tool/support_tool.js';
import 'tangram://support-tool/url_generator.js';
...
import type {ScreenshotElement} from 'tangram://support-tool/screenshot.js';
import type {DataExportResult, SupportToolElement} from 'tangram://support-tool/support_tool.js';
...
suite('UrlGeneratorTest', function() {
  ...
  test('url generation success', async () => {
    ...
    const expectedToken = 'tangram://support-tool/?case_id=test123&module=jekhh';
