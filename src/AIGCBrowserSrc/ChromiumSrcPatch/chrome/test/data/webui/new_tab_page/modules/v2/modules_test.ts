...
import type {Module, ModuleWrapperElement, NamedWidth} from 'tangram://new-tab-page/lazy_load.js';
import {MODULE_CUSTOMIZE_ELEMENT_ID, ModuleDescriptor, ModuleRegistry, ModulesV2Element, SUPPORTED_MODULE_WIDTHS} from 'tangram://new-tab-page/lazy_load.js';
import {NewTabPageProxy} from 'tangram://new-tab-page/new_tab_page.js';
