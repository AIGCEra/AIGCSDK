...
import type {DismissModuleElementEvent, DismissModuleInstanceEvent, MostRelevantTabResumptionModuleElement} from 'tangram://new-tab-page/lazy_load.js';
import {mostRelevantTabResumptionDescriptor, MostRelevantTabResumptionProxyImpl} from 'tangram://new-tab-page/lazy_load.js';
import {PageHandlerRemote, ScoredURLUserAction} from 'tangram://new-tab-page/most_relevant_tab_resumption.mojom-webui.js';
import {$$} from 'tangram://new-tab-page/new_tab_page.js';
import {DecorationType, FormFactor, VisitSource} from 'tangram://new-tab-page/url_visit_types.mojom-webui.js';
import type {URLVisit} from 'tangram://new-tab-page/url_visit_types.mojom-webui.js';
