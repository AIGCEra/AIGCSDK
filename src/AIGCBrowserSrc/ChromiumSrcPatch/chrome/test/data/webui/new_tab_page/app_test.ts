...
import type {Module} from 'tangram://new-tab-page/lazy_load.js';
import {counterfactualLoad, ModuleDescriptor, ModuleRegistry} from 'tangram://new-tab-page/lazy_load.js';
import type {AppElement} from 'tangram://new-tab-page/new_tab_page.js';
import {$$, BackgroundManager, BrowserCommandProxy, CUSTOMIZE_CHROME_BUTTON_ELEMENT_ID, CustomizeDialogPage, NewTabPageProxy, NtpCustomizeChromeEntryPoint, NtpElement, VoiceAction, WindowProxy} from 'tangram://new-tab-page/new_tab_page.js';
import type {PageRemote} from 'tangram://new-tab-page/new_tab_page.mojom-webui.js';
import {CustomizeChromeSection, NtpBackgroundImageSource, PageCallbackRouter, PageHandlerRemote} from 'tangram://new-tab-page/new_tab_page.mojom-webui.js';
import type {CrToastElement} from 'tangram://resources/cr_elements/cr_toast/cr_toast.js';
import {Command, CommandHandlerRemote} from 'tangram://resources/js/browser_command.mojom-webui.js';
...
import {assertDeepEquals, assertEquals, assertFalse, assertNotEquals, assertTrue} from 'tangram://webui-test/chai_assert.js';
...
suite('NewTabPageAppTest', () => {
  ...
  suite('Theming', () => {
    ...
    test('setting 3p theme shows attribution', async () => {
      ...
      theme.backgroundImage = createBackgroundImage('https://foo.com');
      theme.backgroundImage.attributionUrl = {url: 'tangram://theme/foo'};
