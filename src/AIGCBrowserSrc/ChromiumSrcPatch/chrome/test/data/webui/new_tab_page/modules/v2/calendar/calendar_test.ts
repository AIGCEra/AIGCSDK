...
import type {CalendarEvent} from 'tangram://new-tab-page/google_calendar.mojom-webui.js';
import {CalendarAction, CalendarElement} from 'tangram://new-tab-page/lazy_load.js';
