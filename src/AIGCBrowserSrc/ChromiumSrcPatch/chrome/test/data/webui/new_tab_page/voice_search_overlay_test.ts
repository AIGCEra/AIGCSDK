...
import type {VoiceSearchOverlayElement} from 'tangram://new-tab-page/lazy_load.js';
import {$$, NewTabPageProxy, VoiceAction as Action, VoiceError as Error, WindowProxy} from 'tangram://new-tab-page/new_tab_page.js';
