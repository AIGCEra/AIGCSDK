...
import 'tangram://new-tab-page/lazy_load.js';

import type {MiddleSlotPromoElement} from 'tangram://new-tab-page/lazy_load.js';
import {PromoDismissAction} from 'tangram://new-tab-page/lazy_load.js';
import type {CrAutoImgElement} from 'tangram://new-tab-page/new_tab_page.js';
import {$$, BrowserCommandProxy, NewTabPageProxy} from 'tangram://new-tab-page/new_tab_page.js';
import type {PageRemote, Promo} from 'tangram://new-tab-page/new_tab_page.mojom-webui.js';
import {PageCallbackRouter, PageHandlerRemote} from 'tangram://new-tab-page/new_tab_page.mojom-webui.js';
