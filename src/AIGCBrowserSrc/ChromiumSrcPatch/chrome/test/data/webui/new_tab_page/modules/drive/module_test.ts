...
import {FileSuggestionHandlerRemote} from 'tangram://new-tab-page/file_suggestion.mojom-webui.js';
import type {DismissModuleEvent, DriveModuleElement} from 'tangram://new-tab-page/lazy_load.js';
import {driveDescriptor, FileProxy} from 'tangram://new-tab-page/lazy_load.js';
