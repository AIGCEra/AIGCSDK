...
import 'tangram://system/shared/key_value_pair_viewer/key_value_pair_viewer.js';
import 'tangram://system/strings.m.js';

import {loadTimeData} from 'tangram://resources/js/load_time_data.js';
import {COLLAPSE_THRESHOLD} from 'tangram://system/shared/key_value_pair_viewer/key_value_pair_entry.js';
import type {KeyValuePairEntry, KeyValuePairEntryElement} from 'tangram://system/shared/key_value_pair_viewer/key_value_pair_entry.js';
import type {KeyValuePairViewerElement} from 'tangram://system/shared/key_value_pair_viewer/key_value_pair_viewer.js';
...
import {getTrustedHtml} from 'tangram://webui-test/trusted_html.js';
