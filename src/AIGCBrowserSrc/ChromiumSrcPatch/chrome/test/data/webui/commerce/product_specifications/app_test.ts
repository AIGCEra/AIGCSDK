...
import 'tangram://compare/app.js';

import {CrFeedbackOption} from '//resources/cr_elements/cr_feedback_buttons/cr_feedback_buttons.js';
import {COLUMN_MODIFICATION_HISTOGRAM_NAME, CompareTableColumnAction, LOADING_END_EVENT_TYPE, LOADING_START_EVENT_TYPE} from 'tangram://compare/app.js';
import type {ProductSpecificationsElement} from 'tangram://compare/app.js';
import type {ProductSelectorElement} from 'tangram://compare/product_selector.js';
import {Router} from 'tangram://compare/router.js';
import type {ProductInfo, ProductSpecifications, ProductSpecificationsProduct, ProductSpecificationsSet, ProductSpecificationsValue} from 'tangram://compare/shopping_service.mojom-webui.js';
import {WindowProxy} from 'tangram://compare/window_proxy.js';
import {BrowserProxyImpl} from 'tangram://resources/cr_components/commerce/browser_proxy.js';
import {PageCallbackRouter, UserFeedback} from 'tangram://resources/cr_components/commerce/shopping_service.mojom-webui.js';
...
import {assertArrayEquals, assertEquals, assertFalse, assertTrue} from 'tangram://webui-test/chai_assert.js';
...
import {eventToPromise, isVisible} from 'tangram://webui-test/test_util.js';
...
suite('AppTest', () => {
  ...
  suite('FeatureState', () => {
    ...
    test('sync button click when user is signed in', async () => {
      ...
      assertEquals('tangram://settings/syncSetup/advanced', arg);
    });
  });
});
