...
import 'tangram://system/app.js';

import {loadTimeData} from 'tangram://resources/js/load_time_data.js';
import type {AppElement} from 'tangram://system/app.js';
import {BrowserProxyImpl} from 'tangram://system/browser_proxy.js';
import type {SystemLog} from 'tangram://system/browser_proxy.js';
