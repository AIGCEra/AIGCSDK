...
import {CrAutoImgElement} from 'tangram://resources/cr_elements/cr_auto_img/cr_auto_img.js';
...
suite('CrAutoImgElementTest', () => {
  ...
  ([
    ['https://foo.com/img.png', 'tangram://image/?https://foo.com/img.png'],
    ['tangram://foo/img.png', 'tangram://foo/img.png'],
  ...
  test(
      ...
      () => {
        ...
        // Assert.
        assertEquals(`tangram://image/?${autoSrc}`, img.src);
      });
