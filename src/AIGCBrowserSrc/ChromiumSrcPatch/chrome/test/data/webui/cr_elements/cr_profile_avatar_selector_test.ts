...
import type {CrProfileAvatarSelectorElement} from 'tangram://resources/cr_elements/cr_profile_avatar_selector/cr_profile_avatar_selector.js';
...
suite('cr-profile-avatar-selector', function() {
  ...
  test('Can select avatar', async function() {
    ...
    items[2]!.click();
    await microtasksFinished();
    assertEquals('tangram://avatar3.png', avatarSelector.selectedAvatar!.url);
