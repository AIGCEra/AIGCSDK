...
import type {PasswordsSectionElement} from 'tangram://password-manager/password_manager.js';
import {Page, PasswordManagerImpl, PromoCardsProxyImpl, Router, SyncBrowserProxyImpl, UrlParam} from 'tangram://password-manager/password_manager.js';
...
suite('PasswordsSectionTest', function() {
  ...
  test('promo card shown', async function() {
    ...
    assertEquals(
        'tangram://password-manager/images/test_promo.svg', shownImage.src);
