...
import type {AccountInfo, SyncBrowserProxy, SyncInfo} from 'tangram://password-manager/password_manager.js';
import {TrustedVaultBannerState} from 'tangram://password-manager/password_manager.js';
