...
import type {SiteFaviconElement} from 'tangram://password-manager/password_manager.js';
...
suite('SiteFaviconTest', function() {
  ...
  test('on successful download', async function() {
    ...
    icon.url = 'tangram://resources/images/chrome_logo_dark.svg';
  ...
  test('on failed download', async function() {
    icon.domain = 'https://test.com';
    icon.url = 'tangram://resources/images/invalid_url';
