...
import type {ProfileData, Tab, TabSearchPageElement} from 'tangram://tab-search.top-chrome/tab_search.js';
import {TabAlertState, TabSearchApiProxyImpl} from 'tangram://tab-search.top-chrome/tab_search.js';
