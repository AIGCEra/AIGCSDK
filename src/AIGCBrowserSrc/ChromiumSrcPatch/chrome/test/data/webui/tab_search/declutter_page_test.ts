...
import type {DeclutterPageElement, Tab} from 'tangram://tab-search.top-chrome/tab_search.js';
import {TabSearchApiProxyImpl} from 'tangram://tab-search.top-chrome/tab_search.js';
