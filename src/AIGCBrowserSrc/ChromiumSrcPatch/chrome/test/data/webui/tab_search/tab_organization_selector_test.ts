...
import type {AutoTabGroupsPageElement, DeclutterPageElement, Tab, TabOrganizationSelectorButtonElement, TabOrganizationSelectorElement} from 'tangram://tab-search.top-chrome/tab_search.js';
import {TabOrganizationFeature, TabOrganizationState, TabSearchApiProxyImpl} from 'tangram://tab-search.top-chrome/tab_search.js';
