...
import type {SearchOptions} from 'tangram://tab-search.top-chrome/tab_search.js';
import {search, getHostname, getTitle, TabData, TabItemType} from 'tangram://tab-search.top-chrome/tab_search.js';
    ...
    assertSearchOrders(
        ...
        [
          new TabData(
              ...
              'tangram://tab-search'),
          new TabData(
              createTab({title: 'tangram://tab-search'}), TabItemType.OPEN_TAB,
              'tangram://tab-search'),
          new TabData(
              createTab({title: 'tangram://tab-search'}), TabItemType.OPEN_TAB,
              'tangram://tab-search'),
