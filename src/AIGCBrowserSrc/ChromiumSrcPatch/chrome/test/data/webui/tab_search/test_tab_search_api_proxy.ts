...
import type {PageRemote, ProfileData, SwitchToTabInfo, Tab, TabOrganizationSession, TabSearchApiProxy, UserFeedback} from 'tangram://tab-search.top-chrome/tab_search.js';
import {PageCallbackRouter, TabOrganizationFeature, TabOrganizationModelStrategy, TabSearchSection} from 'tangram://tab-search.top-chrome/tab_search.js';
