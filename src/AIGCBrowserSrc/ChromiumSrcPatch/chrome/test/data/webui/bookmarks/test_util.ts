...
import type {BookmarksFolderNodeElement, FolderOpenState, NodeMap} from 'tangram://bookmarks/bookmarks.js';
import {normalizeNodes} from 'tangram://bookmarks/bookmarks.js';
