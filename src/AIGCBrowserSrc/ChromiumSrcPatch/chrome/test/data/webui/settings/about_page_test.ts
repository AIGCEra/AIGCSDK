...
import type {SettingsAboutPageElement, SettingsRoutes} from 'tangram://settings/settings.js';
import {AboutPageBrowserProxyImpl, LifetimeBrowserProxyImpl, Route, Router, resetRouterForTesting} from 'tangram://settings/settings.js';
...
import {ABOUT_PAGE_PRIVACY_POLICY_URL, OpenWindowProxyImpl} from 'tangram://settings/settings.js';
...
import type {PromoteUpdaterStatus} from 'tangram://settings/settings.js';
// </if>

// <if expr="not chromeos_ash">
import {UpdateStatus} from 'tangram://settings/settings.js';
import {webUIListenerCallback} from 'tangram://resources/js/cr.js';
import {assertFalse, assertNotEquals} from 'tangram://webui-test/chai_assert.js';
import {isVisible, eventToPromise} from 'tangram://webui-test/test_util.js';
// </if>
...
suite('AllBuilds', function() {
  ...
  // <if expr="not chromeos_ash">
  const SPINNER_ICON: string = 'tangram://resources/images/throbber_small.svg';
