...
// clang-format off
import type {CardInfo, EntryPointInfo, NotificationPermission, SafetyHubBrowserProxy, UnusedSitePermissions} from 'tangram://settings/lazy_load.js';
import {CardState} from 'tangram://settings/lazy_load.js';
