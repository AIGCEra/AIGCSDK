...
import type {FontsBrowserProxy, FontsData,SettingsAppearanceFontsPageElement} from 'tangram://settings/lazy_load.js';
import {FontsBrowserProxyImpl} from 'tangram://settings/lazy_load.js';
