...
// clang-format off
import type {MetricsReporting, PrivacyPageBrowserProxy, ResolverOption, SecureDnsSetting} from 'tangram://settings/settings.js';
import {SecureDnsMode, SecureDnsUiManagementMode} from 'tangram://settings/settings.js';
