...
import type {SettingsAxAnnotationsSectionElement, SettingsToggleButtonElement} from 'tangram://settings/lazy_load.js';
import {ScreenAiInstallStatus} from 'tangram://settings/lazy_load.js';
