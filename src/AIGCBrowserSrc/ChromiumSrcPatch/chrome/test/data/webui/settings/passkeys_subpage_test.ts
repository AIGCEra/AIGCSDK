...
import type {Passkey, PasskeysBrowserProxy, SettingsPasskeysSubpageElement, SettingsSimpleConfirmationDialogElement} from 'tangram://settings/lazy_load.js';
import {PasskeysBrowserProxyImpl} from 'tangram://settings/lazy_load.js';
