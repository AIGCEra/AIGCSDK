...
import {resetRouterForTesting, buildRouter, loadTimeData, Route, Router, routes, resetPageVisibilityForTesting} from 'tangram://settings/settings.js';
...
suite('Basic', function() {
  ...
  test(
      ...
      function() {
        ...
        assertEquals(
            'tangram://settings/cookies', routes.COOKIES.getAbsolutePath());
        ...
        assertEquals(
            'tangram://settings/downloads',
            Router.getInstance().getCurrentRoute().getAbsolutePath());
        assertEquals(
            'tangram://settings/languages', routes.LANGUAGES.getAbsolutePath());
      });
