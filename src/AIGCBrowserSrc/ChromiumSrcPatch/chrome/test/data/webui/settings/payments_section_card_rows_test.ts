...
import {CardBenefitsUserAction, loadTimeData, MetricsBrowserProxyImpl, OpenWindowProxyImpl} from 'tangram://settings/settings.js';
...
suite('PaymentsSectionCardRows', function() {
  ...
  test('verifyCardImage', async function() {
    ...
    assertEquals(
        'tangram://theme/IDR_AUTOFILL_CC_GENERIC 1x, tangram://theme/IDR_AUTOFILL_CC_GENERIC@2x 2x',
        cardImage.srcset);
  });
