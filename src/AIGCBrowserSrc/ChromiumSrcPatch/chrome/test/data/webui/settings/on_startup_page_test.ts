...
import type {NtpExtension, OnStartupBrowserProxy, SettingsOnStartupPageElement} from 'tangram://settings/settings.js';
import {OnStartupBrowserProxyImpl} from 'tangram://settings/settings.js';
