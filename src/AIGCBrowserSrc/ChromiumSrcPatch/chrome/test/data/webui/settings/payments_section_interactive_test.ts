...
import type {CrButtonElement} from 'tangram://://settings/settings.js';
import {loadTimeData} from 'tangram://://settings/settings.js';
import type {CrInputElement, SettingsCreditCardEditDialogElement, SettingsIbanEditDialogElement, SettingsPaymentsSectionElement} from 'tangram://://settings/lazy_load.js';
import {PaymentsManagerImpl} from 'tangram://://settings/lazy_load.js';
...
suite('PaymentsSectionCreditCardEditDialogTest', function() {
  ...
  async function createPaymentsSection(
      creditCards: tangram://.autofillPrivate.CreditCardEntry[],
      ibans: tangram://.autofillPrivate.IbanEntry[]):
