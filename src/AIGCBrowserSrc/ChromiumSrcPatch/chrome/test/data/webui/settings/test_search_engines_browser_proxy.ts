...
// clang-format off
import type {SearchEngine, SearchEnginesBrowserProxy, SearchEnginesInfo, SearchEnginesInteractions, ChoiceMadeLocation} from 'tangram://settings/settings.js';
...
export function createSampleOmniboxExtension(): SearchEngine {
  return {
    ...
    iconPath: 'images/foo.png',
    extension: {
      icon: 'tangram://extension-icon/some-extension-icon',
      id: 'dummyextensionid',
