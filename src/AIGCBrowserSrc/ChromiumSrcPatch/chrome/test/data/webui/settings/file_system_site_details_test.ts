...
import type {FileSystemGrant, OriginFileSystemGrants} from 'tangram://settings/lazy_load.js';
import {FileSystemSiteDetailsElement, SiteSettingsPrefsBrowserProxyImpl} from 'tangram://settings/lazy_load.js';
