...
import type {DownloadsBrowserProxy, SettingsDownloadsPageElement} from 'tangram://settings/lazy_load.js';
import {DownloadsBrowserProxyImpl} from 'tangram://settings/lazy_load.js';
