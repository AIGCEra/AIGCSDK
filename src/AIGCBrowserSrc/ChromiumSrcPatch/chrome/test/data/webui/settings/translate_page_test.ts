...
import type {CrIconButtonElement, LanguageHelper, SettingsAddLanguagesDialogElement, SettingsTranslatePageElement} from 'tangram://settings/lazy_load.js';
...
import {assertDeepEquals, assertEquals, assertTrue, assertFalse} from 'tangram://webui-test/chai_assert.js';
