...
import type {AccountManagerBrowserProxy, SettingsPeoplePageElement} from 'tangram://settings/settings.js';
import {AccountManagerBrowserProxyImpl, loadTimeData, pageVisibility, ProfileInfoBrowserProxyImpl, Router, SignedInState, StatusAction, SyncBrowserProxyImpl} from 'tangram://settings/settings.js';
