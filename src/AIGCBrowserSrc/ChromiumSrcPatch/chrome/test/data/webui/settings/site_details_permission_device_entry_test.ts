...
import type {SiteDetailsPermissionDeviceEntryElement} from 'tangram://settings/lazy_load.js';
import {ChooserType, SiteSettingsPrefsBrowserProxyImpl} from 'tangram://settings/lazy_load.js';
