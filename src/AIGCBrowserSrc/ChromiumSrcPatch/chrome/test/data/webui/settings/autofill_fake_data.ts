...
// clang-format off
import type {AutofillManagerProxy, PaymentsManagerProxy, PersonalDataChangedListener} from 'tangram://settings/lazy_load.js';
...
export function createCreditCardEntry():
  ...
  return {
    ...
    imageSrc: 'tangram://theme/IDR_AUTOFILL_CC_GENERIC',
    metadata: {
      isLocal: true,
      summaryLabel: card + ' ' +
          '****' + cardNumber.substr(-4),
