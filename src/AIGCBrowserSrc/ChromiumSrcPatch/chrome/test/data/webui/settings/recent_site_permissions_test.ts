...
import type {SettingsRecentSitePermissionsElement} from 'tangram://settings/lazy_load.js';
import {ContentSetting, ContentSettingsTypes, SiteSettingSource, SiteSettingsPrefsBrowserProxyImpl} from 'tangram://settings/lazy_load.js';
