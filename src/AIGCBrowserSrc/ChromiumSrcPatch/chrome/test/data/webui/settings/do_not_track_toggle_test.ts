...
import type {SettingsDoNotTrackToggleElement} from 'tangram://settings/lazy_load.js';
import type {SettingsToggleButtonElement} from 'tangram://settings/settings.js';
import {MetricsBrowserProxyImpl, PrivacyElementInteractions} from 'tangram://settings/settings.js';
