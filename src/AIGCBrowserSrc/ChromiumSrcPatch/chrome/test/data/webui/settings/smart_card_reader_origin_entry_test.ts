...
import type {SmartCardReaderOriginEntryElement} from 'tangram://settings/lazy_load.js';
import {SiteSettingsPrefsBrowserProxyImpl} from 'tangram://settings/lazy_load.js';
...
import type {SiteFaviconElement} from 'tangram://settings/settings.js';
import {assertEquals, assertStringContains, assertTrue} from 'tangram://webui-test/chai_assert.js';
