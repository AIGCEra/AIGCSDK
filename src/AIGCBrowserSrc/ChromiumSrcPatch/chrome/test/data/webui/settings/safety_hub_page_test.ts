...
import type {CardInfo, SettingsSafetyHubPageElement} from 'tangram://settings/lazy_load.js';
import {CardState, ContentSettingsTypes, SafeBrowsingSetting, SafetyHubBrowserProxyImpl, SafetyHubEvent} from 'tangram://settings/lazy_load.js';
import type {SettingsPrefsElement} from 'tangram://settings/settings.js';
import {CrSettingsPrefs, LifetimeBrowserProxyImpl, MetricsBrowserProxyImpl, PasswordManagerImpl, PasswordManagerPage, Router, routes, SafetyHubModuleType, SafetyHubSurfaces} from 'tangram://settings/settings.js';
