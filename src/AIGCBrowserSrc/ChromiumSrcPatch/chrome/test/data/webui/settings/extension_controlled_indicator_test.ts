...
import type {ExtensionControlledIndicatorElement} from 'tangram://settings/settings.js';
import {OpenWindowProxyImpl, ExtensionControlBrowserProxyImpl} from 'tangram://settings/settings.js';
...
suite('extension controlled indicator', function() {
  ...
  test('tapping manage button invokes browser proxy', async function() {
    ...
    assertEquals(url, `tangram://extensions/?id=${indicator.extensionId}`);
  });
