...
import type {SettingsOfferWritingHelpPageElement, SettingsPrefsElement} from 'tangram://settings/settings.js';
import {COMPOSE_PROACTIVE_NUDGE_DISABLED_SITES_PREF, COMPOSE_PROACTIVE_NUDGE_PREF, CrSettingsPrefs} from 'tangram://settings/settings.js';
