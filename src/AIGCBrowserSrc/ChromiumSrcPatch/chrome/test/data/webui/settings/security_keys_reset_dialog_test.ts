...
import type {SecurityKeysResetBrowserProxy, SettingsSecurityKeysResetDialogElement} from 'tangram://settings/lazy_load.js';
import {ResetDialogPage, SecurityKeysResetBrowserProxyImpl} from 'tangram://settings/lazy_load.js';
