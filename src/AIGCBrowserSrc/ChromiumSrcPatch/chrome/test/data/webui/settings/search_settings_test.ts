...
import type {SearchManager} from 'tangram://settings/settings.js';
import {BaseMixin, getSearchManager, getTrustedHTML as getTrustedStaticHtml} from 'tangram://settings/settings.js';
