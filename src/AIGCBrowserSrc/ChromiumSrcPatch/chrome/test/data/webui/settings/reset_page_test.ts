...
import type {CrCheckboxElement, SettingsResetPageElement, SettingsResetProfileDialogElement} from 'tangram://settings/lazy_load.js';
import {ResetBrowserProxyImpl, Router, routes} from 'tangram://settings/settings.js';
