...
import type {LanguageHelper, SettingsLanguagesPageElement} from 'tangram://settings/lazy_load.js';
import {LanguagesBrowserProxyImpl, LanguageSettingsMetricsProxyImpl, LanguageSettingsPageImpressionType} from 'tangram://settings/lazy_load.js';
...
// <if expr="is_win">
import {LanguageSettingsActionType} from 'tangram://settings/lazy_load.js';
// </if>
