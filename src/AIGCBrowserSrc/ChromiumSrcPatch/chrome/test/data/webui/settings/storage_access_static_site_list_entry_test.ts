...
import type {StorageAccessStaticSiteListEntry, StorageAccessStaticSiteListEntryElement} from 'tangram://settings/lazy_load.js';
import {ContentSettingsTypes, SiteSettingsPrefsBrowserProxyImpl} from 'tangram://settings/lazy_load.js';
