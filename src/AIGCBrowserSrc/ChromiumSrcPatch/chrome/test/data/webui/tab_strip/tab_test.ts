...
import 'tangram://tab-strip.top-chrome/tab.js';

import {getFavicon} from 'tangram://resources/js/icon.js';
...
import type {Tab} from 'tangram://tab-strip.top-chrome/tab_strip.mojom-webui.js';
import {TabNetworkState} from 'tangram://tab-strip.top-chrome/tab_strip.mojom-webui.js';
import {CloseTabAction, TabsApiProxyImpl} from 'tangram://tab-strip.top-chrome/tabs_api_proxy.js';
