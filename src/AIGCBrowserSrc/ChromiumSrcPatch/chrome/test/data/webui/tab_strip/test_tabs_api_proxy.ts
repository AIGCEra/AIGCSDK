...
import type {PageRemote} from 'tangram://tab-strip.top-chrome/tab_strip.mojom-webui.js';
import {PageCallbackRouter} from 'tangram://tab-strip.top-chrome/tab_strip.mojom-webui.js';
import type {Tab, TabGroupVisualData} from 'tangram://tab-strip.top-chrome/tab_strip.mojom-webui.js';
import {TabNetworkState} from 'tangram://tab-strip.top-chrome/tab_strip.mojom-webui.js';
import type {CloseTabAction, TabsApiProxy} from 'tangram://tab-strip.top-chrome/tabs_api_proxy.js';
