...
import 'tangram://tab-strip.top-chrome/tab_list.js';

import {FocusOutlineManager} from 'tangram://resources/js/focus_outline_manager.js';
import type {TabElement} from 'tangram://tab-strip.top-chrome/tab.js';
import type {TabGroupElement} from 'tangram://tab-strip.top-chrome/tab_group.js';
import type {TabListElement} from 'tangram://tab-strip.top-chrome/tab_list.js';
import {setScrollAnimationEnabledForTesting} from 'tangram://tab-strip.top-chrome/tab_list.js';
import type {PageRemote, Tab} from 'tangram://tab-strip.top-chrome/tab_strip.mojom-webui.js';
import {TabsApiProxyImpl} from 'tangram://tab-strip.top-chrome/tabs_api_proxy.js';
