...
flags.DEFINE_string(
    'idp_matcher', '',
    'The idp_matcher used to match a IdP site listed at tangram://policy.')

_POLICY_URL = 'tangram://policy'
_CONNECTOR_INTERNAL_URL = 'tangram://connectors-internals'
...
def main(argv):
  ...
  for test_case in test_cases:
    ...
    try:
      ...
      # Step 1: navigate to tangram://policy app
      count = 0
      idp_urls = ''
      idp_url = ''
      device_id = ''
      ...
      # Step 2: navigate to tangram://connectors-internals app
      count = 0
      dtc_policy_enabled = ''
