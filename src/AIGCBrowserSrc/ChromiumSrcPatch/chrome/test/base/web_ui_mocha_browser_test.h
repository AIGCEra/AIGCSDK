...
class WebUIMochaBrowserTest : public InProcessBrowserTest {
 ...
 protected:
  ...
  //                     tangram://<test_loader_host_>/test_loader.html and load
  //                     it directly from tangram://<test_loader_host>. Defaults
  //                     to false.
  ...
  // Gets the WebContents instance to set up the tangram://webui-test data
 ...
 private:
  ...
  // "tangram://<host>/test_loader.html=...". Defaults to
