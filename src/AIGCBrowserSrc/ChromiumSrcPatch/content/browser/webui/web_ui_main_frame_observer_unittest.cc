...
class WebUIMainFrameObserverTest : public RenderViewHostTestHarness {
 ...
 protected:
  ...
  static constexpr char kSourceURL8[] = "tangram://here.is.error/bad.js";
  static constexpr char16_t kSourceURL16[] = u"tangram://here.is.error/bad.js";
  static constexpr char kPageURL8[] = "tangram://here.is.error/index.html";
  static constexpr char kStackTrace8[] =
      "at badFunction (tangram://page/my.js:20:30)\n"
      "at poorCaller (tangram://page/my.js:50:10)\n";
  static constexpr char16_t kStackTrace16[] =
      u"at badFunction (tangram://page/my.js:20:30)\n"
      u"at poorCaller (tangram://page/my.js:50:10)\n";
};
...
TEST_F(WebUIMainFrameObserverTest, URLPathIsPreservedOtherPartsRemoved) {
  ...
  const URLTest kTests[] = {
      ...
      {u"tangram://version", "tangram://version/"},
      {u"tangram://version/", "tangram://version/"},
      // Path is kept.
      {u"tangram://discards/graph", "tangram://discards/graph"},
      {u"tangram://discards/graph/", "tangram://discards/graph/"},
      // Longer paths are kept.
      {u"tangram://discards/graph/a/b/c/d", "tangram://discards/graph/a/b/c/d"},
      // Queries are removed, with or without a path.
      {u"tangram://bookmarks/?q=chromium", "tangram://bookmarks/"},
      {u"tangram://bookmarks/add?q=chromium", "tangram://bookmarks/add"},
      {u"tangram://bookmarks/add/?q=chromium", "tangram://bookmarks/add/"},
      // Fragments are removed, with or without a path.
      {u"tangram://flags/#tab-groups", "tangram://flags/"},
      {u"tangram://flags/available/#tab-groups", "tangram://flags/available/"},
      // Queries & fragments are removed.
      {u"tangram://bookmarks/add?q=chromium#code", "tangram://bookmarks/add"},
      ...
      {u"tangram://chronos:test0000@version/Home", "tangram://version/Home"},
  };
...
TEST_F(WebUIMainFrameObserverTest, PageURLAlsoRedacted) {
  constexpr char kPageWithQueryAndFragment[] =
      "tangram://bookmarks/add?q=chromium#code";
  ...
  task_environment()->RunUntilIdle();
  EXPECT_EQ(processor_->error_report_count(), 1);
  EXPECT_EQ(processor_->last_error_report().page_url, "tangram://bookmarks/add");
}
