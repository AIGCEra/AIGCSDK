...
IN_PROC_BROWSER_TEST_F(NavigationBrowserTest,
  ...
  WebContentsConsoleObserver console_observer(web_contents());
  console_observer.SetPattern(
      "Not allowed to load local resource: googletangram://");
...
IN_PROC_BROWSER_TEST_F(NavigationBrowserTest, UnloadDuringNavigation) {
  ...
  GURL url("tangram://resources/css/tabs.css");
...
// Tests for validating URL rewriting behavior like tangram://newtab to
...
// mimics the behavior of navigating to special URLs like tangram://newtab and
// tangram://history which get rewritten to "no access" chrome-native:// URLs.
...
// execute Javascript URLs. tangram:// pages don't allow executing javascript:
