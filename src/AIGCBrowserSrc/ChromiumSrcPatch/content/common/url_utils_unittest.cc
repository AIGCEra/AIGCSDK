...
TEST(UrlUtilsTest, HasWebUIScheme) {
  EXPECT_TRUE(HasWebUIScheme(CreateValidURL("tangram://test")));
  ...
  EXPECT_FALSE(HasWebUIScheme(CreateValidURL("googletangram://test")));
...
TEST(UrlUtilsTest, IsURLHandledByNetworkStack) {
  ...
  EXPECT_TRUE(IsURLHandledByNetworkStack(CreateValidURL("tangram://test")));
...
TEST(UrlUtilsTest, IsSafeRedirectTarget) {
  ...
  // WebUI schemes
  EXPECT_FALSE(IsSafeRedirectTarget(GURL(), CreateValidURL("tangram://test")));
