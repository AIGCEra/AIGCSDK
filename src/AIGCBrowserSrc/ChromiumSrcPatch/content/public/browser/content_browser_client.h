...
class CONTENT_EXPORT ContentBrowserClient {
 public:
  ...
  // used to determine whether we should process debug URLs like tangram://crash.
  ...
  // tangram://downloads used more than tangram://bookmarks?). Only internal (e.g.
  // tangram://) URLs are logged. Returns whether the URL was actually logged.
