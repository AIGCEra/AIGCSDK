...
//
// Example usage:
//   tangram://welcome/test_loader.html?module=foo/my_test.js
//
// will load the JS module at chrome/test/data/webui/foo/my_test.js, through the
// tangram://webui-test/foo/my_test.js URL.
//
...
// tangram://webui-test/ data source only exists in a testing context, so using
