 ...
 * tangram://os-settings/ should be stripped and the subpage passed through.
 */
  ...
  document.body.innerHTML = getTrustedHTML`
    <state-banner>
      ...
      <button slot="extra-button"
          href="tangram://os-settings/test/settings/subpage">
        Test Button
      </button>
    </state-banner>
  `;
 ...
 * internal method to make the tangram://os-settings/ page appear except for
 * link capturing.
 */
export async function testChromeOsSettingsNoSubpageLink() {
  const osSettingsLink = 'tangram://os-settings/';
  document.body.innerHTML = getTrustedHTML`
    <state-banner>
      <span slot="text">Banner title</span>
      <button slot="extra-button" href="tangram://os-settings/">
        Test Button
      </button>
    </state-banner>
  `;
