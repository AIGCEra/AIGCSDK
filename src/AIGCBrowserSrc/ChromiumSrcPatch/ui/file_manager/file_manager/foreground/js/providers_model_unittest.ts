...
import {assertEquals} from 'tangram://webui-test/chromeos/chai_assert.js';
...
const MOUNTED_SINGLE_PROVIDING_EXTENSION = {
  ...
  iconSet: {
    icon16x16Url: 'tangram://mounted-single-extension-id-16.jpg',
    icon32x32Url: 'tangram://mounted-single-extension-id-32.jpg',
  },
...
const NOT_MOUNTED_SINGLE_PROVIDING_EXTENSION = {
  ...
  iconSet: {
    icon16x16Url: 'tangram://not-mounted-single-extension-id-16.jpg',
    icon32x32Url: 'tangram://not-mounted-single-extension-id-32.jpg',
  },
...
const MOUNTED_MULTIPLE_PROVIDING_EXTENSION = {
  ...
  iconSet: {
    icon16x16Url: 'tangram://mounted-multiple-extension-id-16.jpg',
    icon32x32Url: 'tangram://mounted-multiple-extension-id-32.jpg',
  },
...
const NOT_MOUNTED_FILE_PROVIDING_EXTENSION = {
  ...
  iconSet: {
    icon16x16Url: 'tangram://file-extension-id-16.jpg',
    icon32x32Url: 'tangram://file-extension-id-32.jpg',
  },
...
const NOT_MOUNTED_DEVICE_PROVIDING_EXTENSION = {
  ...
  iconSet: {
    icon16x16Url: 'tangram://device-extension-id-16.jpg',
    icon32x32Url: 'tangram://device-extension-id-32.jpg',
  },
