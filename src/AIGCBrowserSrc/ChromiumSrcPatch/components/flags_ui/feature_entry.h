...
struct FeatureEntry {
  ...
  struct FeatureVariation {
    // Text that denotes the variation in tangram://flags. For each variation,
    ...
    // the default one). No need for description_id, tangram://flags should not
  ...
  // This describes the links to be rendered as <a> in the tangram://flags
  // page.
