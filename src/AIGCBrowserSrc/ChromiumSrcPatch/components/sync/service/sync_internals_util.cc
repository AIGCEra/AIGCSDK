...
// This class represents one field in tangram://sync-internals. It gets
...
// A section for display on tangram://sync-internals, consisting of a title and a
// list of fields.
class Section {
 public:
...
// tangram://sync-internals which are grouped into sections and populated with
