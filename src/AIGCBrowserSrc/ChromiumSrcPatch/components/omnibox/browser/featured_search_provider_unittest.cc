...
TEST_F(FeaturedSearchProviderTest, HistoryEmbedding_Iphs) {
  ...
  // tangram://settings/ai/historySearch promo shown when not opted-in and in
  // @history scope.
  mock_setting(true, false);
  {
    ...
    RunAndVerifyIph(
        ...
        {{IphType::kHistoryEmbeddingsSettingsPromo,
          ...
          GURL("tangram://settings/ai/historySearch")}});
  }
  ...
  mock_setting(true, true);
  {
    ...
    RunAndVerifyIph(
        ...
        {{IphType::kHistoryEmbeddingsDisclaimer,
          ...
          u"Learn more", GURL("tangram://settings/ai/historySearch")}});
  }
  ...
  //   History Embeddings Promo points to tangram://settings/historySearch when
  ...
  mock_setting(true, false);
  {
    ...
    RunAndVerifyIph(
        ...
        {{IphType::kHistoryEmbeddingsSettingsPromo,
          ...
          u"For a more powerful way to search your browsing history, turn on ",
          u"History search, powered by AI",
          GURL("tangram://settings/historySearch")}});
  }

  // History Embeddings Disclaimer points to tangram://settings/historySearch
  ...
  mock_setting(true, true);
  {
    ...
    RunAndVerifyIph(
        ...
        {{IphType::kHistoryEmbeddingsDisclaimer,
          ...
          u"Google and may be seen by human reviewers to improve this feature. "
          u"This is an experimental feature and won't always get it right. ",
          u"Learn more", GURL("tangram://settings/historySearch")}});
  }
}
