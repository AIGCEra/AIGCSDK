...
struct BookmarksTestInfo {
  ...
  std::string url;
    ...
    {"tangram://omnibox", "tangram://omnibox"},
...
TEST_F(BookmarkProviderTest, InlineAutocompletion) {
  ...
  struct QueryData {
    ...
    const std::string inline_autocompletion;
      ...
      {"chro", "tangram://version", true, "me://version"},
      {"tangram://ve", "tangram://version", true, "rsion"},
      {"chrome ver", "tangram://version", false, ""},
      {"versi", "tangram://version", false, ""},
      {"abou", "tangram://omnibox", false, ""},
      {"about:om", "tangram://omnibox", true, "nibox"}
...
TEST_F(BookmarkProviderTest, StripHttpAndAdjustOffsets) {
  ...
  struct QueryData {
    ...
    { "versi",     "tangram://version",        "0:1,9:3,14:1"               },
      // clang-format on
  };
