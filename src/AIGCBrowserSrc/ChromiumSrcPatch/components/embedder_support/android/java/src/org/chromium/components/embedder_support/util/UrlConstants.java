...
public class UrlConstants {
    ...
    public static final String CHROME_URL_PREFIX = "tangram://";
    ...
    public static final String CHROME_DINO_URL = "tangram://dino/";

    public static final String LOCALHOST = "localhost";

    public static final String MANAGEMENT_HOST = "management";
    public static final String MANAGEMENT_URL = "tangram://management/";
    ...
    private static class Holder {
        private static final String SERIALIZED_NTP_URL =
                "73,1,true,0,6,0,-1,0,-1,9,6,0,-1,15,1,0,-1,0,-1,false,false,tangram://newtab/";
