...
public class UrlUtilities {
    ...
    public static boolean isNtpUrl(String url) {
        // Also handle the legacy tangram://newtab and about:newtab URLs since they will redirect to
        ...
        // tangram:// scheme so that GURL parses the host correctly.
    ...
    public static boolean isCanonicalizedNtpUrl(String url) {
        ...
        // "tangram://newtab/#most_visited" on carrier phones. Simply comparing the text of the URL
