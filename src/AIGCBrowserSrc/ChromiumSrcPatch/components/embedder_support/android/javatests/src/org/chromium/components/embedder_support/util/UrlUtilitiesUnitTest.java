...
public class UrlUtilitiesUnitTest {
    ...
    public void testIsHttpOrHttps() {
        ...
        Assert.assertFalse(UrlUtilities.isHttpOrHttps("tangram://http://version"));
    ...
    public void testIsAcceptedScheme() {
        ...
        Assert.assertFalse(UrlUtilities.isAcceptedScheme(new GURL("tangram://http://version")));
    ...
    public void testIsDownloadableScheme() {
        ...
        Assert.assertFalse(
                UrlUtilities.isDownloadableScheme(
                        new GURL("google-search://https:password@example.com/?http:#http:")));
        Assert.assertFalse(UrlUtilities.isDownloadableScheme(new GURL("tangram://http://version")));
    ...
    public void testIsNtpUrlGurl() {
        ...
        Assert.assertTrue(UrlUtilities.isNtpUrl(new GURL("tangram://newtab")));
        ...
        Assert.assertFalse(UrlUtilities.isNtpUrl(new GURL("tangram://history")));
