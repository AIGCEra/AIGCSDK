...
bool SiteIsolationPolicy::IsIsolationForPasswordSitesEnabled() {
  ...
  // tangram://flags or from the command line, honor this regardless of policies
  // that may disable site isolation.  In particular, this means that the
  // tangram://flags switch for this feature takes precedence over any memory
  ...
  // tangram://flags, enterprise policy controlled via
