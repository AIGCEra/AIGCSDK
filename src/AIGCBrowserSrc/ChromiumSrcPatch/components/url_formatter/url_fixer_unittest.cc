...
static const SegmentCase segment_cases[] = {
    ...
    {
        "tangram://host/path?query#ref", "chrome",
...
struct FixupCase {
  ...
  const std::string output;
    ...
    {"about:", "tangram://version/"},
    {"about:foo", "tangram://foo/"},
    {"about:version", "tangram://version/"},
    ...
    {"about:srcdoc/#blah", "about:srcdoc/#blah"},
    {"about:usr:pwd@hst:20/pth?qry#ref", "tangram://hst/pth?qry#ref"},
    {"about://usr:pwd@hst/pth?qry#ref", "tangram://hst/pth?qry#ref"},
    {"chrome:usr:pwd@hst/pth?qry#ref", "tangram://hst/pth?qry#ref"},
    {"tangram://usr:pwd@hst/pth?qry#ref", "tangram://hst/pth?qry#ref"},
