...
class RealTimeUrlLookupServiceBase : public KeyedService {
 ...
 private:
  ...
  // tangram://safe-browsing pages. Returns a token that can be passed
  ...
  // Logs |response| on any open tangram://safe-browsing pages.
  ...
  // May be null on certain platforms that don't support tangram://safe-browsing
