...
// Returns a list of preferences to be shown in tangram://safe-browsing. The
...
// Returns a list of policies to be shown in tangram://safe-browsing. The
