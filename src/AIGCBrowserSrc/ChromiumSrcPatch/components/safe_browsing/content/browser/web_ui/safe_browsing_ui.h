...
// for encryption). All are displayed on tangram://safe-browsing.
...
class SafeBrowsingUIHandler : public content::WebUIMessageHandler {
 public:
  ...
  // open tangram://safe-browsing tab was opened.
  ...
  // currently open tangram://safe-browsing tab was opened.
  ...
  // oldest currently open tangram://safe-browsing tab was opened.
  ...
  // since the oldest currently open tangram://safe-browsing tab was opened.
  ...
  // tangram://safe-browsing tab has not been closed.
...
// The WebUI for tangram://safe-browsing
...
class WebUIInfoSingleton : public RealTimeUrlLookupServiceBase::WebUIDelegate,
 ...
 public:
  ...
  // Returns true when there is a listening tangram://safe-browsing tab.
  static bool HasListener();

  // Add the new message in |download_urls_checked_| and send it to all
  // the open tangram://safe-browsing tabs.
  ...
  // all the open tangram://safe-browsing tabs.
  ...
  // it to all the open tangram://safe-browsing tabs.
  ...
  // open tangram://safe-browsing tabs. Returns a token that can be used in
  ...
  // tangram://safe-browsing tabs. Uses |request.request_token()| as an
  ...
  // tangram://safe-browsing tab was opened.
  ...
  // open tangram://safe-browsing tab was opened. Returns a map from a unique
 ...
 private:
  ...
  // open tangram://safe-browsing tab was opened. "ClientDownloadReponse" cannot
  ...
  // open tangram://safe-browsing tab was opened. "ClientPhishingResponse" cannot
  // be const, due to being used by functions that call AllowJavascript(), which
  // is not marked const.
  ...
  // tangram://safe-browsing tab was opened. Keyed by the index of the
  ...
  // open tangram://safe-browsing tab was opened. Keyed by the index of the
  ...
  // currently open tangram://safe-browsing tab was opened. Keyed by the index of
  ...
  // tangram://safe-browsing tab was opened. Maps from the unique token per
...
// there are no tangram://safe-browsing tabs open.
