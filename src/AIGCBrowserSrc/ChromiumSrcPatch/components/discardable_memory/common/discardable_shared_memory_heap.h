...
class DISCARDABLE_MEMORY_EXPORT DiscardableSharedMemoryHeap {
 ...
 public:
  ...
  // Dumps memory statistics for tangram://tracing.
 ...
 private:
  class DISCARDABLE_MEMORY_EXPORT ScopedMemorySegment {
   public:
    ...
    // Used for dumping memory statistics from the segment to tangram://tracing.
  ...
  // Dumps memory statistics about a memory segment for tangram://tracing.
