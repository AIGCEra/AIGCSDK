...
const StringWithRedaction kStringsWithRedactions[] = {
    ...
    {"tangram://resources/foo",  // Secure chrome resource, exempt.
     "tangram://resources/foo", PIIType::kNone},
    {"tangram://settings/crisper.js",  // Exempt settings URLs.
     "tangram://settings/crisper.js", PIIType::kNone},
    ...
    {"tangram://resources/f?user=bar",  // Potentially PII in parameter.
     "(URL: 2)", PIIType::kURL},
...
TEST_F(RedactionToolTest, RedactAndKeepSelectedHashes) {
  ...
  const std::pair<std::string, std::string> redaction_strings_with_hashes[] = {
    {"tangram://resources/"
     "f?user="
     "99887766554433221100ffeeddccbbaaaabbccddeeff00112233445566778899",
     "tangram://resources/f?user=(HASH:9988 1)"},  // URL that contains a hash.
    {"/root/27540283740a0897ab7c8de0f809add2bacde78f/foo",
