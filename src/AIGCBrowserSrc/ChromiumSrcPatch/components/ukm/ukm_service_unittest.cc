...
TEST_F(UkmServiceTest, PurgeAppDataFromUnsentLogStore) {
  ...
  std::string os_settings_url = "tangram://os-settings";
...
TEST_F(UkmServiceTest, SanitizeChromeUrlParams) {
  struct {
    ...
    const char* expected_url;
      ...
      {"tangram://version/?foo=bar", "tangram://version/"},
      {"about:blank?foo=bar", "about:blank"},
      {"tangram://histograms/Variations", "tangram://histograms/Variations"},
