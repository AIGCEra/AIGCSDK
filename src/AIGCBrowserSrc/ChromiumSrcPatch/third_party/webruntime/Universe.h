...
EXTERN_C const IID IID_IBrowser;
    ...
    public:
        ...
        virtual /* [id][propput] */ HRESULT STDMETHODCALLTYPE put_DrawHandle( 
            /* [in] */ LONGLONG newVal) = 0;
    ...
    typedef struct IBrowserVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IBrowser, put_DrawHandle)
        /* [id][propput] */ HRESULT ( STDMETHODCALLTYPE *put_DrawHandle )( 
            IBrowser * This,
            /* [in] */ LONGLONG newVal);
...
#define IBrowser_put_DrawHandle(This,newVal)	\
    ( (This)->lpVtbl -> put_DrawHandle(This,newVal) ) 
