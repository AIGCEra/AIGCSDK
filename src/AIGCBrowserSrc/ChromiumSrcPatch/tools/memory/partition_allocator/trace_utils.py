...
Takes a trace from tangram://tracing and returns a Python dict containing the
...
- Collect a trace with the memory-infra category enabled (in tangram://tracing)
