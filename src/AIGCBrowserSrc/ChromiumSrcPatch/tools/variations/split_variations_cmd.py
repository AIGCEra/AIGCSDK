...
Go to tangram://version/?show-variations-cmd, at the bottom a few commandline
...
tangram://version/?show-variations-cmd. This command splits them into two sets.
...
tangram://version/?show-variations-cmd to Chrome in "Command Prompt" won't work.
...
def ParseVariationsCmdFromString(input_string):
  ...
  Commandline switches string comes from tangram://version/?show-variations-cmd.
...
def SplitVariationsCmd(results):
  ...
  The commandline switches come from tangram://version/?show-variations-cmd.
  """
