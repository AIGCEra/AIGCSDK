...
Test your histograms using `tangram://histograms`. Make sure they're being
...
Pro tip: You can filter the set of histograms shown on `tangram://histograms` by
appending to the URL. For example, `tangram://histograms/UserActions` shows
