...
class HtmlInlineUnittest(unittest.TestCase):
  ...
  def testInlineCSSLinks(self):
    ...
    files = {
      ...
      <head>
      <link rel="stylesheet" href="foo.css">
      <link rel="stylesheet" href="tangram://resources/bar.css">
      </head>
      </html>
      ''',

      'foo.css': '''
      @import url(tangram://resources/blurp.css);
      blink {
        display: none;
      }
      ''',
...
'''
  ...
  def testImgSrcset(self):
    ...
    files = {
      ...
      <img src="tangram://theme/img11.png" srcset="img7.png 1x, '''\
          '''tangram://theme/img13.png 2x">
    ...
    expected_inlined = '''
      ...
      <img src="tangram://theme/img11.png" srcset="data:image/png;base64,'''\
          '''YTc= 1x,tangram://theme/img13.png 2x">
  ...
  def testSourceSrcset(self):
    ...
    files = {
      ...
      <source src="tangram://theme/img11.png" srcset="img7.png 1x, '''\
          '''tangram://theme/img13.png 2x">
    ...
    expected_inlined = '''
      ...
      <source src="tangram://theme/img11.png" srcset="data:image/png;'''\
          '''base64,YTc= 1x,tangram://theme/img13.png 2x">
