...
namespace CommonUniverse {
	...
	public:
		...
		virtual BOOL InitWebRT(void* pVoid) {
			return TRUE;
		}
		...
		virtual CNucleusProxy* OnNucleusCreated(INucleus* pNewNucleus) { return nullptr; }
		virtual CNucleiProxy* OnNucleiCreated(INuclei* pNewNucleus) { return nullptr; }
	...
	public:
		...
		virtual IDispatch* CreateObject(BSTR bstrObjID, HWND hParent, IXobj* pHostNode, CWebPageImpl*) { return nullptr; }
	...
	public:
		...
		virtual CChromeBookmarkTabHelperDelegate* CreateBookmarkTabHelperDelegate(CChromeBookmarkTabHelper*) { return nullptr; }
	};
		...
		virtual bool WebRTInit(CString strID)
		{
			...
			if (strID != _T("") && g_pWebRTImpl == nullptr)
			{
				...
				if (hModule) {
					...
					_pWebRTFunction = (GetWebRTImpl)GetProcAddress(hModule, "GetWebRTImpl");
	...
	public:
		...
		virtual void UpdateContentRect(HWND hWebContent, RECT& rc, int nTopFix, float dwDeviceScaleFactor) {}
