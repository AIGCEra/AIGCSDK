...
BEGIN_MESSAGE_MAP(CMFCMDTApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMFCMDTApp::OnAppAbout)
	ON_COMMAND(ID_FILE_NEW_FRAME, &CMFCMDTApp::OnFileNewFrame)
	ON_COMMAND(ID_FILE_NEW, &CMFCMDTApp::OnFileNew)
...
// CMFCMDTApp construction

CMFCMDTApp::CMFCMDTApp() noexcept
{
...
// The one and only CMFCMDTApp object

CMFCMDTApp theApp;


// CMFCMDTApp initialization

BOOL CMFCMDTApp::InitInstance()
{
...
void CMFCMDTApp::OnFileNewFrame()
{
